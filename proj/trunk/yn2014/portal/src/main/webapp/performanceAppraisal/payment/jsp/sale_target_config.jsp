...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="<%=request.getContextPath()%>/platform/theme/style/jquery-ui.css"
	rel="stylesheet" type="text/css" />
<link
...
<body class="easyui-layout">
		...
		<div id="container">
			<form id="searchForm" method="post">
				...
				<table id="sm-payment-order-apply" width="100%">
					<tr>
						<td width="10%">指标编码：</td>
						<td width="40%"><input class="default-text-input wper80"
							name="itemcode" id="itemcode" type="text" /></td>
						<td width="10%">指标描述：</td>
						<td width="40%"><input class="default-text-input wper80"
							name="itemdesc" id="itemdesc" type="text" /></td>
					</tr>
					<tr>
						<td width="10%">业务类型：</td>
						<td width="40%"><input class="default-text-input wper80"
							name="busitype" id="busitype" type="text" /></td>
						<td width="10%">业务描述：</td>
						<td width="40%"><input class="default-text-input wper80"
							name="busidesc" id="busidesc" type="text" /></td>
					</tr>
					<tr height="35px">
						<td colspan="8" align="center">
							...
							%> <a class="default-btn fLeft mr10" href="#"
							id="addBtn">新增</a> <%
 ...
 %> <a
							class="default-btn fLeft mr10" href="#" id="searchBtn">查询</a> <a
							class="default-btn fLeft mr10" href="#" id="resetBtn">重置</a> <a
