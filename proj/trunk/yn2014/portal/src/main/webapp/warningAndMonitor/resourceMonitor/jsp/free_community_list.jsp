...
<script type="text/javascript" src="<%=path%>/warningAndMonitor/resourceMonitor/js/free_community_list.js"></script>
					...
					<div id="chose-place">
						<table width="100%" style="margin:10px 0;">
			                <tr style="height:35px">
			                    ...
			                    <td width="6%" style="padding-left:10px;" align="right">小区编码：</td>
