...
<script type="text/javascript" src="<%=request.getContextPath()%>/workflow/workorder/activityApproval/processEdit/js/import_channel_edit.js?v=12"></script>
...
<body>
    ...
    <div id="addFormDiv" style="display:none;">
           ...
           <table style="border-collapse:separate; border-spacing:0px 10px;">
                ...
                <tr><th>装修补贴：</th><td><input required id="zx_bt" type="text" name="up_zx_bt"/></td></tr>
                <tr><th>合作模式：</th><td><select id="hz_ms"><option value ="专营-他建他营">专营-他建他营</option><option value ="专营-自建他营">专营-自建他营</option></select></td></tr>
                <tr><th>房租（房补）：</th><td><input required id="fw_fee" type="text" name="up_fw_fee"/></td></tr>
                <tr><th>考核进度：</th></tr>
