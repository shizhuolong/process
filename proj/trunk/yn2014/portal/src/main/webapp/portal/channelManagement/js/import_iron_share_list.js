...
function search(pageNumber) {
	...
	var time=$("#time").val();
	var code=$("#code").val();
	var sql="SELECT "+field.join(",")+" FROM PMRT.TAB_MRT_IRON_SHARE_MON WHERE DEAL_DATE='"+time+"'";
	var orgLevel=$("#orgLevel").val();
