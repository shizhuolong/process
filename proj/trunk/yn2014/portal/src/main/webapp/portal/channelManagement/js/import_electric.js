...
function downloadFile() {
	window.location.href=$("#ctx").val()+"/electric/import-electric!downfile.action";
}
...
function complete(){
	...
	var flag=checkOptions();
	 if(flag){
		...
		var action=$("#ctx").val()+"/electric/import-electric!importToTemp.action?fileType="+$("#fileType").val();
...
function toBack(){
	 window.location.href=$("#ctx").val()+"/portal/channelManagement/jsp/import_electric_list.jsp";
}