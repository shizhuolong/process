...
<script type="text/javascript" src="<%=path%>/portal/channelManagement/js/chnl_acct_all_mon.js?v=8"></script>
</head>
	...
	<div class="search-div">
				<table style="margin: 0px 0; border:none;width:100%;font-size:100%;">
					<tr>
					    ...
					    <td width="2%" style="text-align:right;">增存量：</td>
						<td width="2%">
						     <select name="acct_type" id="acct_type" class="default-text-input wper100">
