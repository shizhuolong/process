...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/schoolManagement/js/add_school_head.js"></script>
...
<body>
    ...
    <input type="hidden" id="schoolName" value="<%=URLDecoder.decode(request.getParameter("school_name")) %>">
    <div id="addFormDiv" align="center" style="margin-top: 50px">
           ...
           <table style="border-collapse:separate; margin:10px,0px; border-spacing:0px 10px;">
                <tr><th>学校：</th><td><input id="school_name" readonly="readonly" type="text" name="school_name"/></td></tr>
