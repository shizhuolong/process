...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/portal/channelManagement/js/import_user_order.js"></script>
	<style>
		th {
			...
			<div class="main-block">
				...
				<div id="chose-sender">
					...
					<form id="uploadForm" name="mainForm"
						action="<%=request.getContextPath()%>/channelManagement/userOrder_importToTemp.action"
