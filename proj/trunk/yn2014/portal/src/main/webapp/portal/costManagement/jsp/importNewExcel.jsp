...
<%
	...
	String dealDate=new SimpleDateFormat("yyyy").format(ca.getTime());
%>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/costManagement/js/importNewExcel.js"></script>
</head>
			...
			<table class="list_table">
				...
				<tr>
								...
								<td width="2%">
						            ...
						            onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy',isShowClear:false})" value="<%=dealDate%>" id="dealDate" name="dealDate"/>
						         </td>
							</tr>
				<tr>
					<td style="width: 70px;text-align: right;">上传文件：</td>
					<td>
						<input  type="file" size='70' name="myFile"/>
					</td>
				</tr>
				<tr>
					<td></td>
