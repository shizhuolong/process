...
function downloadFile() {
	window.location.href=$("#ctx").val()+"/channelManagement/ironPro_downfile.action";
}
...
function complete(){
	...
	var flag=checkOptions();
	 if(flag){
		...
		var action=$("#ctx").val()+"/channelManagement/ironPro_importToTemp.action?fileType="+$("#fileType").val();
...
function toBack(){
	 window.location.href=$("#ctx").val()+"/portal/channelManagement/jsp/import_iron_pro_list.jsp";
}