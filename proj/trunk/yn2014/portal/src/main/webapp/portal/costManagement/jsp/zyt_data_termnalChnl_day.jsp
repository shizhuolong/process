...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/costManagement/js/zyt_data_termnalChnl_day.js?v=6"></script> 
<style type="text/css">
body {
    color: #717171;
		...
		<div style="padding:5px;border:1px solid #c0e2ef;margin-top:40px;border-top:none;">
			<div class="titleDivStyle">
				<P align=center><FONT style="FONT-SIZE: 14pt; FILTER: shadow(color=#6495ED,strength=15); WIDTH: 100%; COLOR: #4B4B4B;
					 LINE-HEIGHT: 100%; FONT-FAMILY: 方正舒体">自营厅终端销量日通报</FONT></P>
			</div>
