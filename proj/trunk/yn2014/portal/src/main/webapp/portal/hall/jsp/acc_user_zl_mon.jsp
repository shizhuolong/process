...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/hall/js/acc_user_zl_mon.js?v=2"></script>
</head>
	...
	<form id="searchForm" method="post">
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="4%" align="right">渠道状态：</td>
					<td width="6%">
						<input name="status" id="status" class="default-text-input wper80">
					</td>
					<td width="4%" align="right">营服属性：</td>
					<td width="6%">
						<select name="unit_type" id="unit_type" class="default-text-input wper80">
								<option value=''>请选择</option>
