...
<%
	...
	String currentMon = new SimpleDateFormat("yyyy").format(c.getTime());
...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/costManagement/js/import_cost_budget_new_list.js?v=8"></script>
</head>
<body>
								...
								<table id="sm-payment-order-apply" style="width: 100%;">
									...
									<tr>
										...
										<td style="width: 80px;">
											...
											onclick="WdatePicker({isShowClear:false,skin:'whyGreen',dateFmt:'yyyy'})" />
										</td>
