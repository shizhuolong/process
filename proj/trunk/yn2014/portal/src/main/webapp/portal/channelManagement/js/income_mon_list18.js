...
var field=["DEAL_DATE","GROUP_ID_1_NAME","ZY_2G_NUM","JK_2G_NUM","DZ_2G_NUM","SH_2G_NUM","GT_2G_NUM","ALL_2G_NUM","ZY_3G_NUM","JK_3G_NUM","DZ_3G_NUM","SH_3G_NUM","GT_3G_NUM","ALL_3G_NUM","ZY_4G_NUM","JK_4G_NUM","DZ_4G_NUM","SH_4G_NUM","GT_4G_NUM","ALL_4G_NUM","ZY_NET_NUM","JK_NET_NUM","DZ_NET_NUM","SH_NET_NUM","GT_NET_NUM","ALL_NET_NUM","ZY_ZZX_NUM","JK_ZZX_NUM","DZ_ZZX_NUM","SH_ZZX_NUM","GT_ZZX_NUM","ALL_ZZX_NUM","ZY_MOB_NUM","JK_MOB_NUM","DZ_MOB_NUM","SH_MOB_NUM","GT_MOB_NUM","ALL_MOB_NUM","ZY_GW_NUM","JK_GW_NUM","DZ_GW_NUM","SH_GW_NUM","GT_GW_NUM","ALL_GW_NUM","ZY_ALL","JK_ALL","DZ_ALL","SH_ALL","GT_ALL","ALL_NUM","INCOME_ICT_NUM","INCOME_IDT_NUM","ZY_HX","JK_HX","DZ_HX","SH_HX","GT_HX","ALL_HX"];
var report = null;
var downSql="";
...
function search(pageNumber) {
	...
	var sql="SELECT "+field.join(",")+" FROM PMRT.VIEW_MRT_ZYINCOME_2018_MON WHERE DEAL_DATE='"+dealDate+"'";
	sql+=where;
	var orgLevel=$("#orgLevel").val();
