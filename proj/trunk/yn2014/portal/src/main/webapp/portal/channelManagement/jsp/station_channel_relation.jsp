...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/channelManagement/js/station_channel_relation.js"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="8%" style="text-align:right;">县份名称：</td>
					<td width="15%">
				...
				<tr>
					<td width="8%" style="text-align:right;">工位：</td>
					<td width="15%">
						<input type="text" id="user_code" name="user_code"  class="default-text-input wper80"/>
					</td>
					<td width="8%" style="text-align:right;">操作人：</td>
					<td width="15%">
						<input class="default-text-input wper80" name="user_name" type="text" id="user_name"/>
					</td>
					<td width="8%" style="text-align:right;margin-left:5px">是否部门：</td>
					<td width="15%">
						<select name="is_deft" id="is_deft"  class="default-text-input wper80">
							<option value=''>请选择</option>
