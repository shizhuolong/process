...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/channelManagement/js/network_manager_bind_person.js"></script>
</head>
...
<div id="container" style="min-height: 310px;">
	...
	<div class="default-dt" style="width: 500px;">
		<div class="sticky-wrap">
			...
			<tr>
				<td width="50%" class="right" colspan="2" style="border-right: none;">
					<a href="#" class="default-btn fRight mr10" id="saveBtn">确定</a>
				</td>
                <td width="50%" class="left" colspan="2" style="border-left: none;">
