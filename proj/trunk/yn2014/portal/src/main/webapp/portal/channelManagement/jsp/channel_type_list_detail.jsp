...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/channelManagement/js/channel_type_list_detail.js"></script>
<style>
	...
	<div class="sticky-wrap" id="updateFormDiv" style="display:none;">
		<form id="updateForm" method="POST">
		  <input type="hidden" id="id" name="id"/>
			<table class="default-table sticky-enabled">
				<tr>
					<td style="padding-left: 60px;">代理点名称:</td>
					<td><input type="text" required="true" class="easyui-validatebox" missingMessage="代理点名称不能为空" name="type_name" id="type_name"></td>
				</tr>
				<tr></tr>
				<tr>
    ...
    <div class="sticky-wrap" id="addFormDiv" style="display:none;">
		<form id="addForm" method="POST">
			<table class="default-table sticky-enabled">
				<tr>
					<td style="padding-left: 60px;">代理点名称:</td>
					<td><input type="text" required="true" class="easyui-validatebox" missingMessage="代理点名称不能为空" name="type_name" id="add_type_name"></td>
				</tr>
				<tr></tr>
				<tr>
	                <td colspan="2" style="padding-left: 120px;">
