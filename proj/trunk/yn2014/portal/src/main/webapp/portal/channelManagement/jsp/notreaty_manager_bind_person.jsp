...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/channelManagement/js/notreaty_manager_bind_person.js"></script>
</head>
	...
	<div class="default-dt" style="width: 500px;">
			<div class="sticky-wrap">
				<table class="default-table sticky-enabled">
					...
					<tr>
						<td width="50%" class="right" colspan="3"
