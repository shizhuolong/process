...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/channelManagement/js/agent_person_update.js?v=10"></script>
</head>
	...
	<div class="default-dt" style="width: 420px;">
		<div class="sticky-wrap" style="height: 150px;">
			<form id="update" method="POST">
				...
				<tr>
					<td>代理商编码:</td>
					<td><input type="text" required="true" readonly="true" class="easyui-validatebox" missingMessage="代理商编码不能为空" name="hq_chan_code" id="hq_chan_code"/></td>
				    <td>代理商名称:</td>
				...
				<tr>
				    ...
				    <td>电话号码:</td>
					<td><input type="text" required="true" readonly="true" class="easyui-validatebox" missingMessage="电话号码不能为空" name="phone" id="phone"></td>
					<td>人员姓名:</td>
