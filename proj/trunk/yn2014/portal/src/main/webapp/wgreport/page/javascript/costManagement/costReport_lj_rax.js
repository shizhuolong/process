var field= ["INCOME_TOTAL","INCOME_2G","INCOME_3G", "INCOME_4G",
            ...
            "XJ_XZFY","PROFIT","LAN_IRON_AMOUNT",
            "LAN_WARTER_ELE_AMOUNT","LAN_MAINTAI_AMOUNT",
            "LAN_RENT_AMOUNT","LAN_JRCB_AMOUNT","LAN_GOOD_AMOUNT",
            "LAN_XL_AMOUNT","LAN_XZ_AMOUNT","LAN_MAN_AMOUNT",
            "LAN_XZ_SHARE_AMOUNT","LAN_ALL_AMOUNT"];
...
var title=[["营销架构","出帐收入(扣减赠费、退费)","","","","","","","成本费用合计","佣金","","","","","",
            ...
            "铁塔租费（不含水电、油机发电）","网运水电费","代维费",
            "网运房租及物业费","网运线客户接入成本","网优费","网运修理费",
            "网运行政费用","网运人工成本","行政费用（共同）","网运成本合计"],
            ["","合计","2G","3G","4G",
             "宽带","专租线","固话","","合计",
             "2G","3G","4G","固网","公共佣金",
             "","","","","","","","","","","","","","","","","","","","","","","","","","","",""]];
