var cols = ["deal_date","area_name","unit_name","hr_no","user_name","hq_chan_code","hq_name","operator_id","busi_id","busi_desc","sll","bigbusi_code","bigbusi_desc","cre","sl_cre","svr_ratio","svr_cre","unit_ratio","unit_cre","unit_money"];
jQuery(function(){
	//excel导出
	...
	var _limit=20;
	var c=cols.join(",");
	var sql = "select "+c+" from PMRT.TB_MRT_JCDY_SLJF_DETAIL_MON WHERE DEAL_DATE = "+deal_date;
			if(group_level == 1) {
	...
	function init(sql){ 
		var head="";
		head +="<tr class='attend_th'><th class='attend_th'>账期</th><th class='attend_th'>地市</th><th class='attend_th'>营服中心</th><th class='attend_th'>HR编码</th><th class='attend_th'>人员姓名</th><th class='attend_th'>渠道编码</th><th class='attend_th'>渠道名称</th><th class='attend_th'>操作员编码</th><th class='attend_th'>业务编码</th><th class='attend_th'>业务描述</th><th class='attend_th'>受理量</th><th class='attend_th'>业务大类</th><th class='attend_th'>业务大类描述</th><th class='attend_th'>原始积分</th><th class='attend_th'>受理积分</th><th class='attend_th'>服务调节系数</th><th class='attend_th'>服务调节积分</th><th class='attend_th'>区域调节系数</th><th class='attend_th'>区域调节积分</th><th class='attend_th'>积分金额</th></tr>";
...
function downsAll(){
	...
	var showtext="Sheet";
	   ...
	   var _head=["账期","地市","营服中心","HR编码","人员姓名","渠道编码","渠道名称","操作员编码","业务编码","业务描述","受理量","业务大类","业务大类描述","原始积分","受理积分","服务调节系数","服务调节积分","区域调节系数","区域调节积分","积分金额"];
