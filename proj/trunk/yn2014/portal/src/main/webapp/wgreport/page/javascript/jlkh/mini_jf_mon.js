...
function listRegions(){
	var sql = "select distinct t.GROUP_ID_1,t.GROUP_ID_1_NAME from PMRT.TAB_MRT_MINI_JF_MON t where 1=1 ";
	//权限
	var orgLevel=$("#orgLevel").val();
	var code=$("#code").val();
	if(orgLevel==1){
...
function listUnits(regionName){
	var $unit=$("#unitName");
	var sql = "select distinct t.UNIT_NAME from PMRT.TAB_MRT_MINI_JF_MON  t where 1=1 ";
	if(regionName!=''){
