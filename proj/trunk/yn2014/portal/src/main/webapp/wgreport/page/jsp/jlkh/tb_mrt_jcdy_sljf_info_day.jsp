...
<script type="text/javascript" src="<%=request.getContextPath()%>/wgreport/page/javascript/jlkh/tb_mrt_jcdy_sljf_info_day.js"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr>
					...
					<td width="13%">
						<input class="default-text-input wper100" name="itemdesc" type="text" id="itemdesc"/>
					</td>
				</tr>
			</table>
		</form>
...
<script type="text/javascript" src="<%=path %>/wgreport/page/javascript/jlkh/tb_mrt_jcdy_sljf_info_day.js"></script>
