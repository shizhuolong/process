...
<script type="text/javascript" src="<%=request.getContextPath()%>/wgreport/page/javascript/jlkh/tb_mrt_jcdy_qdxsjf_day.js?v=1"></script>
</head>
...
<script type="text/javascript" src="<%=path %>/wgreport/page/javascript/jlkh/tb_mrt_jcdy_qdxsjf_day.js"></script>
