...
<script type="text/javascript" src="<%=path %>/wgreport/page/javascript/costManagement/costReport.js"></script>
	<style type="text/css">
  ...
  <input type="hidden" id="path" value="../" />
	<div class="search-div" style="width: 100%; margin-left: 3px;"
		id="contions">
		<ul>
			<li><span style="font-size: 12px">帐期</span>&nbsp;<input
