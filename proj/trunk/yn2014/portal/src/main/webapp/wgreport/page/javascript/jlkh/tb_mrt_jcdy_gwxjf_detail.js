var cols = ["deal_date","area_name","unit_name","user_name","hr_no","subscription_id","service_num","join_date","operator_id","office_id","product_id","itemcode","itemdesc","nvl(remark,' ') remark","itemvalue","developer_id","hq_chan_name","sourcecre","hq_ratio","hq_cre","unit_ratio","unit_cre","unit_money"];
jQuery(function(){
	//excel导出
	...
	var _limit=20;
	var c=cols.join(",");
	var sql = "select "+c+" from PMRT.TB_MRT_JCDY_GWXJF_DETAIL_MON WHERE DEAL_DATE = "+deal_date;
			if(group_level == 1) {
	...
	function init(sql){ 
		var head="";
		head +="<tr class='attend_th'><th class='attend_th'>账期</th><th class='attend_th'>地市</th><th class='attend_th'>营服中心</th><th class='attend_th'>人员姓名</th><th class='attend_th'>HR编码</th><th class='attend_th'>用户编码</th><th class='attend_th'>用户号码</th><th class='attend_th'>入网时间</th><th class='attend_th'>操作员工号</th><th class='attend_th'>部门编码</th><th class='attend_th'>套餐编码</th><th class='attend_th'>指标编码</th><th class='attend_th'>指标描述</th><th class='attend_th'>备注</th><th class='attend_th'>指标值</th><th class='attend_th'>发展人编码</th><th class='attend_th'>渠道名称</th><th class='attend_th'>原始积分</th><th class='attend_th'>渠道系数</th><th class='attend_th'>乘渠道系数后积分</th><th class='attend_th'>区域系数</th><th class='attend_th'>乘区域系数后积分</th><th class='attend_th'>积分金额</th></tr>";
...
function downsAll(){
	...
	var showtext="Sheet";
	   ...
	   var _head=["账期","地市","营服中心","人员姓名","HR编码","用户编码","用户号码","入网时间","操作员工号","部门编码","套餐编码","指标编码","指标描述","备注","指标值","发展人编码","渠道名称","原始积分","渠道系数","乘渠道系数后积分","区域系数","乘区域系数后积分","积分金额"];
