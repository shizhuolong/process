 var nowData = [];
 var title=[["账期","地市","营服中心","人员姓名","HR编码","宽带续费原始积分","10M以下原始积分","10M以上原始积分","固移融合原始积分","原始积分合计","乘渠道系数后积分","乘区域系数后积分","积分金额"]];
 var field=["DEAL_DATE","AREA_NAME","UNIT_NAME","USER_NAME","HR_NO","GWKDXF","GWDOWN10M","GWUP10M","GYRH","ALLJF","HQ_CRE","UNIT_CRE","UNIT_MONEY"];
 var orderBy = '';
var report = null;
$(function() {
