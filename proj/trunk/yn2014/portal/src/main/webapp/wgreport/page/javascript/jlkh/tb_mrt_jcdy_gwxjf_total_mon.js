jQuery(function(){
	...
	function init(sql){ 
		...
		head +="<tr class='attend_th'>" +
			...
			"<th class='attend_th'>人员姓名</th><th class='attend_th'>HR编码</th><th class='attend_th'>宽带续费</th>" +
			"<th class='attend_th'>10M以下</th><th class='attend_th'>10M以上</th><th class='attend_th'>固移融合</th>" +
			"<th class='attend_th'>积分合计</th><th class='attend_th'>乘渠道系数后积分</th><th class='attend_th'>乘区域系数后积分</th>" +
...
function downsAll(){
	...
	var showtext="Sheet";
	   ...
	   var _head=['账期','地市','基层单元','人员姓名','HR编码','宽带续费','10M以下','10M以上','固移融合','积分合计','乘渠道系数后积分','乘区域系数后积分','积分金额'];
