...
<script type="text/javascript" src="<%=request.getContextPath()%>/wgreport/page/javascript/jlkh/tb_mrt_jcdy_gwxjf_detail.js"></script>
<style>
	...
	<input type="hidden" id="hrId" value="<%=user.getHrId()%>">
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr height="35px">
				    <td width="7%" style="text-align:right;">用户号码：</td>
					<td width="13%">
