...
var treeDataUrl=contextPath+'/'+namespace+'/'+action+'!query.action?treeId=';
    ...
    return {
        ...
        getColumns: function(){
            var columns=[
                            ...
                            {header: "机构名称", width: 40, dataIndex: 'orgName', sortable:true},
                            {header: "编码", width: 40, dataIndex: 'code', sortable:true},
                            {header: "负责人姓名", width: 40, dataIndex: 'chargeMan', sortable:true},
...
TreeModel = function(){
    return{
        getTreeWithContextMenu: function(){
            ...
            var remove=true;
            var modify=true;
            var tree = TreeBaseModel.getTreeWithContextMenu(treeDataUrl+treeId, '组织架构', 'root', 'org', create, remove, modify);
