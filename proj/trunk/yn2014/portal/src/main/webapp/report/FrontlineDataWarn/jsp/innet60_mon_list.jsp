...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/FrontlineDataWarn/js/innet60_mon_list.js?v=1"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="8%">
						<input type="text" id="hq_chan_code" class="default-text-input wper80"/>
					</td>
