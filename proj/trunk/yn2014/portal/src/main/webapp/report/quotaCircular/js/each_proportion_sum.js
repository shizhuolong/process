...
var title=[["帐期","角色类别","统计类别","全省汇总","保山","楚雄","大理","德宏","迪庆","红河","昆明","丽江","临沧","怒江","普洱","曲靖","省集客","文山","版纳","玉溪","昭通"]];
var orderBy='';	
var report = null;
$(function() {
	//listRegions();
...
function getSql(){
	var s="SELECT T.DEAL_DATE,                          "+
			...
			"       T.GROUP_05,                           "+
			"       T.GROUP_10                            "+
			"  FROM PMRT.TB_MRT_JF_ZB_COUNT_PROPORTION T  ";
	return s;
}
/////////////////////////下载开始/////////////////////////////////////////////
function downsAll(){
