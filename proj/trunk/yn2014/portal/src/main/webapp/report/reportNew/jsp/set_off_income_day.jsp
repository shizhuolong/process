...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/set_off_income_day.js"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
                    ...
                    <td width="5%" style="text-align:right;">用户类型：</td>
                    <td width="8%">
                        <select name="isIct" id="isIct" class="default-text-input wper100">
                                <option value=''>请选择</option>
                                <option value='1'>ICT</option>
                                <option value='0'>非ICT</option>
                        </select>
                    </td>
                    <td width="5%">
