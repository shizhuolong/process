...
<title>"<%=groupName%>"-TV业务营销清单明细</title>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/FrontlineDataWarn/js/tv_business_marketing_detail.js"></script>
</head>
