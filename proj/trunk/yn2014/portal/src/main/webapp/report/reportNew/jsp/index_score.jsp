...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/index_score.js?v=1"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
                    ...
                    <td width="5%" align="right">指标名称：</td>
                    <td width="8%">
                        <select name="indexName" id="indexName" class="default-text-input wper80">
                                <option value=''>请选择</option>
                        </select>
                    </td>
                    <td width="5%" align="right">指标级别：</td>
                    <td width="6%">
                        <select name="typeName" id="typeName" class="default-text-input wper80">
                                <option value=''>请选择</option>
                                <option value='省级'>省级</option>
                                <option value='地市'>地市</option>
                        </select>
                    </td>
                    <td width="3%" align="right">姓名：</td>
                    <td width="5%">
                        <input name="nmae" id="nmae" class="default-text-input wper80">
                    </td>
			        <td width="3%">
