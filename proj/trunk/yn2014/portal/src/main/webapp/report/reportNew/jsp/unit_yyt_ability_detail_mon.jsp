...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/unit_yyt_ability_detail_mon.js"></script>
</head>
	...
	<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="6%">经营模式：</td>
                    <td width="10%">
                        <select name="busiMode" id="busiMode" class="default-text-input wper80">
                                <option value=''>请选择</option>
