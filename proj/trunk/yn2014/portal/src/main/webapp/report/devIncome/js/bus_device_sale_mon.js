...
function getSql(orgLevel,where){
	...
	if(orgLevel==1){
		return "SELECT T.GROUP_ID_0 AS ROW_ID,                                                                                                                              "+
		"       '云南省' AS ROW_NAME,                                                                                                                                "+
		"       '-' AS BUS_HALL_NAME,                                                                                                                                "+
		"       '-' AS HQ_CHAN_CODE,                                                                                                                                 "+
		"       '-' AS OPERATE_TYPE,                                                                                                                                 "+
		...
		"                               (SUM(NVL(T.SALE_NUM1, 0))+SUM(NVL(T.SALE_NUM3, 0)) - (SUM(NVL(T3.SALE_NUM1, 0))+SUM(NVL(T3.SALE_NUM3, 0)))) * 100 /          "+
		...
		"   LEFT JOIN PMRT.TB_MRT_BUS_DEVICE_SALE_MON T3                                                                                                             "+
		"    ON (T.HQ_CHAN_CODE = T3.HQ_CHAN_CODE AND T3.DEAL_DATE = "+getLastYearLastMonth(dealDate)+")                                                             "+
		                       where +
		" GROUP BY T.DEAL_DATE, T.GROUP_ID_0                                                                                                                         ";

	}else if(orgLevel==2){
		return "SELECT T.GROUP_ID_1 AS ROW_ID,                                                                                                                              "+
		"       T.GROUP_ID_1_NAME AS ROW_NAME,                                                                                                                                "+
		"       '-' AS BUS_HALL_NAME,                                                                                                                                "+
		"       '-' AS HQ_CHAN_CODE,                                                                                                                                 "+
		"       '-' AS OPERATE_TYPE,                                                                                                                                 "+
		"       '-' AS CHNL_TYPE,                                                                                                                                    "+
		...
		"    ON (T.HQ_CHAN_CODE = T3.HQ_CHAN_CODE AND T3.DEAL_DATE = "+getLastYearLastMonth(dealDate)+")                                                             "+
		                                                           where+                                                                                             
		" GROUP BY T.DEAL_DATE, T.GROUP_ID_0,T.GROUP_ID_1,T.GROUP_ID_1_NAME                                                                                          ";
	}else{
