...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/hq_channel_capacity.js"></script>
<style type="text/css">
...
<body class="" style="overflow-x:auto;">
	...
	<input type="hidden" id=region value="<%=org.getRegionCode()%>">
		<form id="searchForm" method="post" style="width:60%">
			<table style="width:50%;margin: 10px 0; border:none;">
				<tr height="35px">
					<td width="1%" style="padding-left: 1px;" align="right">账期：</td>
					<td width="3%">
			...
			<div style="color:red;">
         备注：渠道数量：集中系统属性为社会实体，当月有销量（移动网+固网）渠道（自营厅除外）。
        </div>
		</form>
