...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/mrt_target_devel_day.js"></script>
</head>
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="13%">
						...
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMMdd',isShowClear:'false'})" readonly='readonly' value="<%=time %>" id="time">
					</td>
					<td width="7%">HR编码：</td>
					<td width="13%">
