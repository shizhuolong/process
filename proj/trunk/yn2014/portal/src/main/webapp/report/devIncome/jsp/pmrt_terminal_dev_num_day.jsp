...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/pmrt_terminal_dev_num_day.js"></script>
</head>
<style>
	...
	<form id="searchForm" method="post">
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<!--  
					<td width="5%" style="padding-left: 10px;">地市：</td>
					<td width="20%">
						<select  id="GROUP_ID_1" onchange="" class="default-text-input wper140">
