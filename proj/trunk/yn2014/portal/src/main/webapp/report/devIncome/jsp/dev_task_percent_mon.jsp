...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/dev_task_percent_mon.js"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="8%">指标：</td>
					<td width="15%">
						<select name="targetName" id="targetName" onchange="" class="default-text-input wper80">
								<option value=''>请选择</option>
								<option value='2gf'>2G发展用户数</option>
								<option value='3gf'>3G发展用户数</option>
								<option value='4gf'>4G发展用户数</option>
						</select>
					</td>
					<td width="8%">姓名：</td>
					<td width="15%">
