...
var report = null;
var orderBy='';
var field=["GROUP_ID_1_NAME","UNIT_NAME" ,"HQ_CHAN_CODE" ,"HQ_CHAN_NAME" ,"BUSI_BEGIN_TIME" ,"HQ_STATE" ,"HQ_ZY" ,"THIRD_TYPE" ,"IS_TY" ,"IS_SOCIAL" ,"IS_DS" ,"END_TIME" ,"START_SHORT_NAME" ,"START_LEVE" ,"DEV_2G_NUM" ,"DEV_3G_NUM" ,"DEV_4G_NUM" ,"DEV_MOB_NUM" ,"DEV_KD_NUM" ,"DEV_ZZX_NUM" ,"DEV_NET_NUM" ,"DEV_OTHER_NUM" ,"DEV_COUNT" ,"CHARGE_YW" ,"CHARGE_GW" ,"ACC_NUM" ,"SR_DETAIL_SUM" ,"SR_DETAIL_YW" ,"SR_DETAIL_ZX" ,"SR_DETAIL_KD" ,"SR_DETAIL_GH" ,"SR_DETAIL_OTHER" ,"SR_DETAIL_SUM1" ,"HQ_COST_ALL" ,"COST_RATE" ,"MAN_COST_CONT" ,"MAN_COST_JM" ,"MAN_COST_FINACE" ,"MAN_COST_ALL" ,"YJ_ALL" ,"HQ_QDBT" ,"TERM_BT" ,"HQ_RENT" ,"HQ_ZX_FEE" ,"KHJR_AMOUNT" ,"KCB_COST" ,"YF_MON_YW" ,"YF_MON_ZX" ,"YF_MON_KD" ,"YF_MON_GH" ,"YF_MON_OTHER" ,"YF_MON_SUM" ,"COMMFEE_MOB_ZSHB" ,"COMMFEE_ZZX_ZSHB" ,"COMMFEE_KD_ZSHB" ,"COMMFEE_NET_ZSHB" ,"COMMFEE_ZSHB" ,"SUBS_OWE" ,"SUBS_PAY" ,"SECOND_PAY" ,"COMM_STOP"];
var title=[["地市","所属基层单元","渠道编码","渠道名称","目前经营者开始合作时间","渠道状态","渠道专业","三级属性","是否自建他营","是否社会化合作","是否代收费点(1是 0不是)","清算终止时间","战略渠道简称","战略渠道级别","发展用户数","","","","","","","","","出账用户数","","","出账收入","其中：出账收入明细","","","","","","成本合计","成本占收比(%)","人工成本（应发数）","","","","佣金","渠道补贴","终端补贴","房租费","营业厅装修","客户接入成本","卡成本","其中：佣金明细分类一","","","","","","其中：佣金占收比分类一","","","","","用户欠费","用户预存款","二次续费率","终止清算佣金"],
