...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/tb_mrt_wxjf_qdjlnew_day.js"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="5%" style="text-align:right;">基层单元：</td>
					<td width="11%">
				...
				<tr height="35px">
					...
					<td width="20%">
						<input class="default-text-input wper90" name="phoneNumber" type="text" id="phoneNumber"/>
					</td>
