...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/kd_mult_zy_day.js?v=2"></script>
<style type="text/css">
	...
	<input type="hidden" id=region value="<%=org.getRegionCode()%>">
		<form id="searchForm" method="post" style="width:60%">
			<table style="width:70%;margin: 10px 0; border:none;">
				<tr height="35px">
					<td width="4%" style="padding-left: 1px;" align="right">账期：</td>
					<td width="10%">
