...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/hq_strategy_details.js?v=1"></script>
<style type="text/css">
	...
	<input type="hidden" id=region value="<%=org.getRegionCode()%>">
		<form id="searchForm" method="post" style="width:60%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
					<td width="15%" style="padding-left: 1px;" align="right">开始账期：</td>
					<td width="20%">
						<input type="text"  class="Wdate default-text-input wper80" 
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM'})" value="<%=dealDate %>" id="startDate">
					</td>
					<td width="15%" style="padding-left: 1px;" align="right">结束账期：</td>
                    <td width="20%">
                        <input type="text"  class="Wdate default-text-input wper80" 
