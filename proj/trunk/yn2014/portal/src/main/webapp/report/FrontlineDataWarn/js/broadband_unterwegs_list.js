...
var title=[["账期","地市名称","营服名","渠道经理","宽带在途清单（数据在BSS系统及运维公客系统，须先打通数据接口）","","","","","","","","","","",""],
           ["","","","","归属地","宽带账号","用户名","装机地址","联系电话","套餐","入网时间","状态","局站","接入方式","宽带速率","发展渠道"]
		];		
var field=["DEAL_DATE","GROUP_ID_NAME","UNIT_NAME","HQ_NAME","GROUP_ID_2_NAME","DEVICE_NUMBER","CUSTOMER_NAME","STD_6_NAME","CONTACT_PHONE","PRODUCT_NAME","INNET_DATE","STATUS_NAME","EXCH_NAME","INPUT_TYPE","SPEED_M","HQ_CHAN_NAME"];
...
function getsql(){
	...
	var sql=" SELECT  T.DEAL_DATE		,			"+	//--账期
			...
			"   FROM PMRT.TB_MRT_GK_PASSAGE_DAY T   "+
