...
function getSql(where,orgLevel){
	...
	if(orgLevel==1){
		...
		preSql="SELECT deal_date,group_id_1_name,unit_name, HQ_CHAN_CODE ROW_ID,HQ_CHAN_NAME ROW_NAME,DEVELOPER_ID,DEVELOPER_NAME,TDC_ID,STROENAME,TDC_NAME,TDC_PHONE,COUNT(*) COUNT,";
