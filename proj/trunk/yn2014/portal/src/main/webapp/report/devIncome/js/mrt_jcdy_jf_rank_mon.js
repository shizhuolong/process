var nowData = [];
var title=[["账期","地市","营服中心","人员姓名","本月累计积分","本月累计薪酬","本月全省排名","本月地市排名","本月营服中心排名"]];
var field=["DEAL_DATE","AREA_NAME","UNIT_NAME","USER_NAME","ALL_JF","ALL_JF_MONEY","PRO_RANK","GROUP_RANK","UNIT_RANK"];
