	...
	<input type="hidden" id="region" value="<%=org.getRegionCode()%>">
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr>
					<td width="4%" style="text-align:right">三无：</td>
					<td width="15%">
					...
					<td width="4%" style="text-align:right">极低：</td>
					<td width="15%">
...
资料完备用户：<br/>
例：1月入网，则考核4月，4月资料完备，则判定为资料完备用户<br/><br/>

极低标准：<br/>

1、截止201510月账期<br/>
语音 &lt;3 分钟 且 流量 &lt;4M 且短信 &lt; 5条<br/>
2、自201511月账期开始<br/>
语音 &lt;5 分钟 且 流量 &lt;3M 且短信 &lt; 4条<br/><br/>
极低用户：<br/>
例：1月入网用户，考核2月3月4月，2月3月都是极低 或 3月4月都是极低，则判定为极低用户<br/></br>

三无标准：<br/>
语音=0 且 流量=0 且 短信=0<br/>
三无用户：<br/>
例：1月入网用户，考核2月3月4月，2月3月都是三无 或 3月4月都是三无，则判定为三无用户<br/><br/>

低饱和标准：<br/>
实际语音小于套餐内语音20%，并且实际流量小于套餐内流量20%，则是低饱和<br/>
低饱和用户：<br/>
例：1月入网用户，考核2月3月4月，2月3月都是低饱和 或 3月4月都是低饱和，则判定为低饱和用户
