...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/income_all_day.js"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
                    ...
                    <td width="8%">
                        <input type="text" style="width:100px" class="Wdate" id="dealDate" readonly="readonly" value="<%=dealDate %>"  onclick="WdatePicker({isShowClear:false,skin:'whyGreen',dateFmt:'yyyyMMdd'})"/>
                    </td>   					
