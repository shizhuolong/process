var nowData = [];
var title=[["组织架构","宽带超过20M且未开通TV业务出账用户数","归属地","宽带账号","用户名","装机地址","联系电话","套餐","入网时间","捆绑手机号码","状态","局站","接入方式","宽带速率","发展渠道","预存款余额"]];		
...
function getsql(){
	...
	var sql="	SELECT T.DEAL_DATE,			"+		//--账期
			...
			"	       T.UNIT_NAME,         "+		//--营服名
			"	       T.HQ_NAME,           "+		//--渠道经理
			"		   T.IS_ACCT,			"+		//--宽带超过20M且未开通TV业务出账用户数
...
function downsAll(){
	...
	var title=[["账期","分公司","营服名","渠道经理","宽带超过20M且未开通TV业务出账用户数","归属地","宽带账号","用户名","装机地址","联系电话","套餐","入网时间","捆绑手机号码","状态","局站","接入方式","宽带速率","发展渠道","预存款余额"]];		
		
	showtext = '智慧沃家营销清单-'+dealDate;
