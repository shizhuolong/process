...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/bus_device_sale_mon.js?v=26"></script>
</head>
<body style="overflow-x:auto;">
	...
	<form id="searchForm" method="post">
			...
			<table width="120%" style="margin: 10px 0; border:none;">
				<tr height="35px">
