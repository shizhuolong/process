var field=["ACCT_2_CHW_NUM",  
           ...
           "FLOW_4G",        
           "AVG_FLOW_4G",
           "ON_2G","ON_3G","ON_4G","ZZX_ZHTZ","ICT_ZHTZ"];
var mmf=[//需要环比的字段
"ACCT_2G_NUM",
"ACCT_3G_NUM",
"ACCT_4G_NUM",
...
["营销架构","2G出账用户","2G出账用户","2G出账用户","2G出账用户","2G出账用户","2G出账用户","2G出账用户",
 ...
 "移网在网用户数","移网在网用户数","移网在网用户数","专租线账后调整收入","专租线账后调整收入"],
["营销架构","长话王","市话王","包打王","流量王","日租卡","其他","合计",/*2G出账*/ 
 ...
 "2G","3G","4G","专租线(不含ICT)","ICT"]
		...
		getSubRowsCallBack:function($tr){
			...
			var sql='select '+preField+','+sumSql+' from PMRT.TAB_MRT_TARGET_HQ_MON t ';
...
function showAgentList($tr){
	...
	var url=$("#ctx").val()+"/report/devIncome/jsp/income_and_dev_target_list.jsp?agentId="+agentId+"&unitId="+unitId+"&startDate="+startDate+"&endDate="+endDate+"&agentType="+perType;
...
function downsAll() {
	...
	showtext = '全业务渠道分类月报-' + startDate+"-"+endDate;
	var title=[["营销架构","","","","","","","","2G出账用户","","","","","","","3G出账用户","","","","","","","","4G出帐用户","","","","","","","","","固网宽带出账用户","","","","","","专租线出账用户","固话出账用户","2G用户发展","","","","","","","3G用户发展","","","","","","","","4G用户发展","","","","","","","","","固网宽带用户发展","","","","","","2G出账收入","","","","","","","3G出账收入","","","","","","","","4G出账收入","","","","","","","","","固网宽带出账收入","","","","","","专租线发展","","专租线收入","","固话发展量","固话收入","2G用户语音流量","","","","3G用户语音流量","","","","4G用户语音流量","","","","移网在网用户数","","","专租线账后调整收入","","渠道属性"],
