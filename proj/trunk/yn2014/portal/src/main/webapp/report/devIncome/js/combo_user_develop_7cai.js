...
var field="";
$(function(){
	$("#dealDate").val(getMaxDate("PMRT.TB_MRT_BUS_QC_DEV_MON"));
	search();
...
function search(){
	var dealDate=$("#dealDate").val();
		//省，地市
		title=[["组织架构","经营模式","厅类型","自有厅新增用户发展量","","","","","","","","","全网新增用户发展量","","","","","","","",""],
		...
		field=["OPERATE_TYPE","CHNL_TYPE","QC_19_NUM","QC_39_NUM","QC_59_NUM","QC_89_NUM","QC_119_NUM","QC_139_NUM","QC_RZK_NUM","ALL_QC_NUM","ALL_QC_HB","QQD_QC_19_NUM","QQD_QC_39_NUM","QQD_QC_59_NUM","QQD_QC_89_NUM","QQD_QC_119_NUM","QQD_QC_139_NUM","QQD_QC_RZK_NUM","QQD_ALL_QC_NUM","QQD_ALL_HB"];
		...
		getSubRowsCallBack:function($tr){
			...
			if($tr){
				...
				if(orgLevel==2){//点击省
					...
					groupBy= "  GROUP BY HQ_CHAN_CODE,BUS_HALL_NAME,OPERATE_TYPE,CHNL_TYPE  ";
				}else{
					return {data:[],extra:{}}
				}
				orgLevel++;
...
function downsAll() {
	...
	var groupBy= " GROUP BY T.DEAL_DATE,T.GROUP_ID_1_NAME,T.BUS_HALL_NAME,T.HQ_CHAN_CODE,T.OPERATE_TYPE,T.GROUP_ID_1,T.CHNL_TYPE ";
	//先根据用户信息得到前几个字段
	...
	title=[["账期","地市","营业厅名称","渠道编码","经营模式","厅类型","自有厅新增用户发展量","","","","","","","",""],
