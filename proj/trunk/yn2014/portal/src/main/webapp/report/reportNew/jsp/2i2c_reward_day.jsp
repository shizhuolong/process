...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/
"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/artDialog4.1.7/artDialog.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/2i2c_reward_day.js"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
                    ...
                    <td width="8%" style="text-align:right;">发展人HR编码：</td>
                    <td width="8%">
                        <input class="default-text-input wper80" name="hrId" type="text" id="hrId"/>
                    </td>
