...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/report/devIncome/js/tmp_jcdy_hr_salary.js"></script>
			...
			<div class="main-block">
				...
				<div id="chose-sender">
					...
					<form id="uploadForm" name="mainForm"
						action="<%=request.getContextPath()%>/devIncome/hrUpload_importTax.action"
