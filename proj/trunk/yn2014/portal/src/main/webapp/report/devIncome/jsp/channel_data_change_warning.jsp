...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/channel_data_change_warning.js"></script>
</head>
	...
	<input type="hidden" id="hrId" value="<%=user.getHrId()%>">
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr>
					<td width="5%" style="text-align:right;">当前开户名：</td>
					 <td width="10%">
						<input type="text" id="nameOfNow"  class="default-text-input wper80"/>
					</td>
					<td width="5%" style="text-align:right;">历史开户名：</td>
					<td width="10%">
						<input class="default-text-input wper80" name="nameOfOld" type="text" id="nameOfOld"/>
					</td>
				</tr>
			</table>
		</form>
