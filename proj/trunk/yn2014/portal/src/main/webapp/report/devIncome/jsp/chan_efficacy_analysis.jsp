...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/chan_efficacy_analysis.js?v=1"></script>
</head>
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="10%">
						...
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM',isShowClear:'false'})" readonly='readonly' value="<%=dealDate %>" id="startDate">
					</td>
					<td width="5%" style="text-align:right;">结束账期：</td>
					<td width="10%">
						<input type="text"  class="Wdate default-text-input wper90" 
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM',isShowClear:'false'})" readonly='readonly' value="<%=dealDate %>" id="endDate">
					</td>
				...
				<tr>
					...
					<td width="10%">
						<input class="default-text-input wper90" name="chanlCode" type="text" id="chanlCode"/>
					</td>
				</tr>
			</table>
		</form>
