...
function getAllSql(where,level){
  ...
  if(level==1){
	  ...
	  "       '--' UNIT_ID,                                                                                                    "+
	  "       '--' UNIT_TYPE,                                                                                                  "+
	  "       SUM(NVL(DEV_YW_NUM,0))  DEV_YW_NUM,                                                                                           "+
	  "       SUM(NVL(DEV_ZX_NUM,0)) DEV_ZX_NUM,                                                                                          "+
	  "       SUM(NVL(DEV_KD_NUM,0)) DEV_KD_NUM,                                                                                          "+
	  "       SUM(NVL(DEV_GH_NUM,0)) DEV_GH_NUM,                                                                                          "+
	  "       SUM(NVL(DEV_OTHER_NUM,0)) DEV_OTHER_NUM,                                                                                     "+
	  "       SUM(NVL(DEV_ALL_NUM,0)) DEV_ALL_NUM,                                                                                         "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_YW_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) CHARGE_YW_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_ZX_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) CHARGE_ZX_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_KD_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) CHARGE_KD_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_GH_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) CHARGE_GH_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_OTHER_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) CHARGE_OTHER_NUM,                                                                                 "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_ALL_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) CHARGE_ALL_NUM,                                                                                     "+
	  ...
	  "       SUM(PMRT.SUM_RATIO((SELECT BUSI_OWE_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) BUSI_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT SUBS_OWE_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) SUBS_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT SUBS_PAY_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=0),"+startDate+","+endDate+")) SUBS_PAY_LEFT,                                                                                       "+
	  ...
	  "       SUM(NVL(DEV_OTHER_NUM,0)) DEV_OTHER_NUM,                                                                                     "+
	  "       SUM(NVL(DEV_ALL_NUM,0)) DEV_ALL_NUM,                                                                                         "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_YW_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) CHARGE_YW_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_ZX_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) CHARGE_ZX_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_KD_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) CHARGE_KD_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_GH_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) CHARGE_GH_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_OTHER_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) CHARGE_OTHER_NUM,                                                                                 "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_ALL_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) CHARGE_ALL_NUM,                                                                                     "+
	  ...
	  "       SUM(PMRT.SUM_RATIO((SELECT BUSI_OWE_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) BUSI_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT SUBS_OWE_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) SUBS_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT SUBS_PAY_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+")) SUBS_PAY_LEFT,                                                                                       "+
	  "      SUM(PMRT.SUM_RATIO((SELECT SECOND_PAY_RATE FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=1 AND GROUP_ID_1=T.GROUP_ID_1),"+startDate+","+endDate+"))||'%' SECOND_PAY_RATE        "+
	  "  FROM PMRT.TAB_MRT_UNIT_ABILITY_MON T                                                                                                              "+
	      where+
	  "   AND T.GROUP_LEVEL = 1                                                                                                                            "+
	  ...
	  "       SUM(NVL(DEV_OTHER_NUM,0)) DEV_OTHER_NUM,                                                                                     "+
	  "       SUM(NVL(DEV_ALL_NUM,0)) DEV_ALL_NUM,                                                                                         "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_YW_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID ),"+startDate+","+endDate+")) CHARGE_YW_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_ZX_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) CHARGE_ZX_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_KD_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) CHARGE_KD_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_GH_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) CHARGE_GH_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_OTHER_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) CHARGE_OTHER_NUM,                                                                                 "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_ALL_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) CHARGE_ALL_NUM,                                                                                     "+
	  "       SUM(PMRT.SUM_RATIO((SELECT YS_SALE_AMOUNT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) YS_SALE_AMOUNT,  "+
	  "       SUM(PMRT.SUM_RATIO((SELECT COM_SALE_RATE FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+"))||'%'  COM_SALE_RATE,        "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_SALE_AMOUNT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_SALE_AMOUNT, "+
	  "       SUM(PMRT.SUM_RATIO((SELECT YS_UNIT_AMOUNT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) YS_UNIT_AMOUNT,        "+
	  "       SUM(PMRT.SUM_RATIO((SELECT COM_UNIT_RATE FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+"))||'%' COM_UNIT_RATE,              "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_UNIT_AMOUNT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_UNIT_AMOUNT,      "+
	  "       SUM(PMRT.SUM_RATIO((SELECT CHARGE_YEAR_YS FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) CHARGE_YEAR_YS,        "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_CHARGE_MON_YS FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_CHARGE_MON_YS,    "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_CHARGE_YW_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_CHARGE_YW_NUM,    "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_CHARGE_ZX_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_CHARGE_ZX_NUM,    "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_CHARGE_KD_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_CHARGE_KD_NUM,    "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_CHARGE_GH_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_CHARGE_GH_NUM,    "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_CHARGE_OTHER_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_CHARGE_OTHER_NUM, "+
	  "       SUM(PMRT.SUM_RATIO((SELECT FACT_CHARGE_ALL_NUM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) FACT_CHARGE_ALL_NUM,   "+
	  ...
	  "       SUM(PMRT.SUM_RATIO((SELECT LAN_COST FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) LAN_COST,              "+
	  "       SUM(PMRT.SUM_RATIO((SELECT LAN_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) LAN_LEFT,              "+
	  "       SUM(PMRT.SUM_RATIO((SELECT LAN_COM FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) LAN_COM,               "+
	  "       SUM(PMRT.SUM_RATIO((SELECT BUSI_OWE_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) BUSI_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT SUBS_OWE_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) SUBS_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO((SELECT SUBS_PAY_LEFT FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+")) SUBS_PAY_LEFT,                                                                                       "+
	  "      SUM(PMRT.SUM_RATIO((SELECT SECOND_PAY_RATE FROM PMRT.TAB_MRT_UNIT_ABILITY_MON WHERE DEAL_DATE="+endDate+" AND GROUP_LEVEL=2 AND UNIT_ID=T.UNIT_ID),"+startDate+","+endDate+"))||'%' SECOND_PAY_RATE        "+
	  "  FROM PMRT.TAB_MRT_UNIT_ABILITY_MON T                                                                                                                                                           "+
	        where+
	  "   AND T.GROUP_LEVEL = 2                                                                                                                                                                         "+
	  "   GROUP BY T.GROUP_ID_1,                                                                                                                                                                        "+
