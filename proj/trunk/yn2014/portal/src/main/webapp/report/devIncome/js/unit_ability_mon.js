...
function getAllSql(where,level){
  ...
  if(level==1){
	  ...
	  "       '--' UNIT_ID,                                                                                                    "+
	  "       '--' UNIT_TYPE,                                                                                                  "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.DEV_YW_NUM,0),"+startDate+","+endDate+")) DEV_YW_NUM,                                                                                          "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.DEV_ZX_NUM,0),"+startDate+","+endDate+")) DEV_ZX_NUM,                                                                                          "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.DEV_KD_NUM,0),"+startDate+","+endDate+")) DEV_KD_NUM,                                                                                          "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.DEV_GH_NUM,0),"+startDate+","+endDate+")) DEV_GH_NUM,                                                                                          "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.DEV_OTHER_NUM,0),"+startDate+","+endDate+")) DEV_OTHER_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.DEV_ALL_NUM,0),"+startDate+","+endDate+")) DEV_ALL_NUM,                                                                                         "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.CHARGE_YW_NUM,0),"+startDate+","+endDate+")) CHARGE_YW_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.CHARGE_ZX_NUM,0),"+startDate+","+endDate+")) CHARGE_ZX_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.CHARGE_KD_NUM,0),"+startDate+","+endDate+")) CHARGE_KD_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.CHARGE_GH_NUM,0),"+startDate+","+endDate+")) CHARGE_GH_NUM,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.CHARGE_OTHER_NUM,0),"+startDate+","+endDate+")) CHARGE_OTHER_NUM,                                                                                    "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.CHARGE_ALL_NUM,0),"+startDate+","+endDate+")) CHARGE_ALL_NUM,                                                                                      "+
	  ...
	  "       SUM(PMRT.SUM_RATIO(NVL(T.BUSI_OWE_LEFT,0),"+startDate+","+endDate+")) BUSI_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.SUBS_OWE_LEFT,0),"+startDate+","+endDate+")) SUBS_OWE_LEFT,                                                                                       "+
	  "       SUM(PMRT.SUM_RATIO(NVL(T.SUBS_PAY_LEFT,0),"+startDate+","+endDate+")) SUBS_PAY_LEFT,                                                                                       "+
