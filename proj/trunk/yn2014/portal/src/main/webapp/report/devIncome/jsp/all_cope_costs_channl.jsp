...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/all_cope_costs_channls.js"></script>
</head>
<body class="" style="overflow-x:auto;">
	...
	<form id="searchForm" method="post" style="width:70%;">
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="5%">
						<a class="default-gree-btn" href="#" id="showRemark" onclick="showRemark()" >查看口径</a>
					</td>
				</tr>
			</table>
	</form>
	...
	<div id="remark" style="display:none;">
	    ...
	    <legend><font size="3" style="color:blue;">备注</font></legend>
	    <table id="_remark" cellspacing="0" cellpadding="0" border="1px;">
	    </table>
  	</fieldset>
	</div>
