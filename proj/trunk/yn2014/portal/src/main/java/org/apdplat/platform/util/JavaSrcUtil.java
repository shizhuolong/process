...
public class JavaSrcUtil {
	...
	public static void main(String[] args) throws IOException {
		File file = new File("E:/work/workspace/maven/APDPlat_Core");
		JavaSrcUtil jsu = new JavaSrcUtil();
		System.out.println(jsu.staticRowsByDirectory(file));
		
		OutputStream os = new FileOutputStream(new File("E:/work/workspace/maven/APDPlat_Core/src/main/java/org/apdplat/module/dictionary/action/DicAction.java"));
