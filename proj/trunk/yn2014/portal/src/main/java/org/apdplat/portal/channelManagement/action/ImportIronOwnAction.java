...
@Controller
@Scope("prototype")
public class ImportIronOwnAction extends BaseAction {
	...
	public void importToResult() throws SQLException {
		...
		String delRepeat = "DELETE PMRT.TAB_MRT_IRON_OWN_MON WHERE DEAL_DATE='"	+ time+ "' AND GROUP_ID_1='"+regionCode+"'" ;
		SpringManager.getUpdateDao().update(delRepeat);
		String importToResult = "INSERT INTO PMRT.TAB_MRT_IRON_OWN_MON SELECT * FROM PMRT.TAB_MRT_IRON_OWN_MON_TEMP WHERE DEAL_DATE='"+time+"' AND GROUP_ID_1='"+ regionCode+"'";
	...
	public String importToTemp() {
		...
		String resultTableName = "PMRT.TAB_MRT_IRON_OWN_MON_TEMP";
	...
	public void downfile() {
		File f=new File(this.request.getRealPath("/portal/channelManagement/down/import_iron_own.xls"));
		...
		try{
			...
			resp.addHeader("content-disposition", "attachment;filename=import_iron_own.xls");
