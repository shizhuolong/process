...
public class ImportMainIncomeAction extends BaseAction {
	...
	public String importToTemp() {
		...
		String field="INSERT_TIME,DEAL_DATE,LOGIN_NAME,GROUP_ID_1,GROUP_ID_1_NAME,ALL_INCOME_NUM,MOB_INCOME_NUM,INCOME_4G_NUM,INCOME_3G_NUM,INCOME_2G_NUM,INCOME_NET_NUM,NOT_ICT_NUM,INCOME_ICT_NUM,INCOME_IDT_NUM";
		if (uploadFile == null) {
			err.add("上传文件为空！");
		} else {
