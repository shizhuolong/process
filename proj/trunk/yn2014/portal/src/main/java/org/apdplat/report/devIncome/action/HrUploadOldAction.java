...
@Controller
@Scope("prototype")
public class HrUploadOldAction extends BaseAction{
	...
	public void downfile() {
		File f=new File(this.request.getRealPath("/report/devIncome/down/tmp_jcdy_hr_old_salary.xls"));
		...
		try{
			...
			resp.addHeader("content-disposition", "attachment;filename=tmp_jcdy_hr_old_salary.xls");
