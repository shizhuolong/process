...
public class Struts2Utils {
	...
	private static Logger logger = Logger.getLogger(Struts2Utils.class);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static void renderJson(final Map map,final JsonConfig config, final String... headers) {
	 ...
	 * @see #render(String, String, String...)
	 */
	public static void renderJson(final Object object,final JsonConfig config, final String... headers) {
	 ...
	 * @see #render(String, String, String...)
	 */
	public static void renderJson(final Collection<?> collction,final JsonConfig cfg, final String... headers) {
		String jsonString = JSONArray.fromObject(collction,cfg).toString();
		render(JSON_TYPE, jsonString, headers);
	}
