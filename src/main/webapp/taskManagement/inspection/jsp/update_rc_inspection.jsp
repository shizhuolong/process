	                       		...
	                       		<table class="overflow-y taskTable" style="margin-top: 5px;">
	                       			<tr>
						                <td style="padding-left: 480px;">
							                <a href="javascript:void(0)" onclick="updateRcInpec()" class="default-btn fLeft mr10" id="confirmBtn">确认</a>
							                <a href="javascript:void(0)" onclick="closeRcDialog()" class="default-btn fLeft ml10" id="cancleBtn">关闭</a>
						                </td>
									</tr>
	                       		</table>
	                       	</div>	
