...
<script type="text/javascript" src="<%=request.getContextPath()%>/taskManagement/saleschedule/js/bus_schedule.js"></script>
<style>
	#lch_DataBody TR TD INPUT{
		width:100px;
	}
</style>
</head>
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="15%">
						...
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM',isShowClear:false})" value="<%=time %>" id="dealDate">
					</td>
					<td width="4%">地市：</td>
					<td width="15%">
					...
					<td width="8%">营业厅编码：</td>
					<td width="15%">
						<input class="default-text-input wper80" name="busCode" type="text" id="busCode"/>
					</td>
					<td width="5%">
