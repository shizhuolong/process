...
<script type="text/javascript" src="<%=request.getContextPath()%>/wgreport/page/javascript/jlkh/mini_jf_mon.js"></script>
</head>
	...
	<input type="hidden" id="hrId" value="<%=user.getHrId()%>">
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr height="35px">
				    <td width="7%" style="padding-left: 10px;">姓名：</td>
					<td width="13%">
