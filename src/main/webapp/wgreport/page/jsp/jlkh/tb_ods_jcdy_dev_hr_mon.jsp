...
<script type="text/javascript" src="<%=request.getContextPath()%>/wgreport/page/javascript/jlkh/tb_ods_jcdy_dev_hr_mon.js"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="8%">地市：</td>
					<td width="15%">
						<input class="default-text-input wper80" name="cityName" type="text" id="cityName"/>
					</td>
					<td width="8%">基层单元：</td>
					<td width="15%">
						<input class="default-text-input wper80" name="unitName" type="text" id="unitName"/>
					</td>
				</tr>
				<tr height="35px">
