...
<script type="text/javascript" src="<%=request.getContextPath()%>/wgreport/page/javascript/jlkh/tb_mrt_jcdy_qdxsjf_info.js?v=1"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="7%" style="text-align:right;">电话号码：</td>
					<td width="13%">
				...
				<tr height="35px">
					...
					<td width="7%" style="text-align:right;">业务描述：</td>
					<td width="13%">
						<input class="default-text-input wper80" name="itemdesc" type="text" id="itemdesc"/>
					</td>
					<td width="7%" style="text-align:right;">备注：</td>
					<td width="13%">
						<input class="default-text-input wper80" name="remark" type="text" id="remark"/>
					</td>
				 </tr>
			</table>
		</form>
