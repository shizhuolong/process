...
var title=[["组织架构","出帐收入(扣减赠费、退费)","","","","","","","市场成本合计","网运成本","","","","","","","","","","","","佣金","","","","","","紧密外包费用","营销费用","","","","","","","",
            "行政费用","","","","","","行政费用(共同)","销售毛利润","纳入网运成本后毛利"],
            ["","2G","3G","4G",
                     "宽带","专租线","固话","合计","",
                     "铁塔租费（不含水电）","网运水电费","代维费","网运房租及物业费","网运线客户接入成本合计","客户接入成本开通费","客户接入成本终端","网运费","网运修理费","网运行政费用","网运人工成本","网运成本合计",
                     "2G","3G","4G","固网","公共佣金","合计",
                     "","渠道补贴","终端补贴","卡成本","营业厅房租(装修)","水电物业费","广告宣传费","业务用品印制及材料费","营销费用小计",
...
function downsAll() {
	...
	var title=[["地市","营服中心","营服编码","出帐收入(扣减赠费、退费)","","","","","","","市场成本合计","网运成本","","","","","","","","","","","","佣金","","","","","","紧密外包费用","营销费用","","","","","","","",
	                  "行政费用","","","","","","行政费用(共同)","销售毛利润","纳入网运成本后毛利"],
	                  ["","","","2G","3G","4G",
	                           "宽带","专租线","固话","合计","",
	                           "铁塔租费（不含水电）","网运水电费","代维费","网运房租及物业费","网运线客户接入成本合计","客户接入成本开通费","客户接入成本终端","网运费","网运修理费","网运行政费用","网运人工成本","网运成本合计",
