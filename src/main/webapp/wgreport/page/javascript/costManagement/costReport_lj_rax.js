...
var title=[["组织架构","营服编码","出帐收入(扣减赠费、退费)","","","","","","","","成本费用合计","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","毛利","销售毛利"],
           ...
           ["","","","","","","","","","","2G","3G","4G","专租线","宽带","固话","其他","合计","紧密外包费用","渠道补贴","终端补贴","卡成本","营业厅房租(装修)","水电物业费","广告宣传费","业务用品印制及材料费","营销费用小计","车辆使用费","招待费","办公费","差旅费","通信费","铁塔租费（不含水电）","网运水电费","代维费","网运房租及物业费","客户接入成本开通费","客户接入成本终端","网优费","网运修理费","网运行政费用（拨测费、财产保险、车辆使用费）","网运成本合计","网运人工成本","","",""]];
