...
var title=[["组织架构","出帐收入(扣减赠费、退费)","","","","","","","成本费用合计","佣金","","","","","","营销费用","","","","","","","","",
            "行政费用","","","","","","行政费用(共同)","网运成本","","","","","","","","","","","","毛利润","剔除网运成本后毛利"],
            ["","合计","2G","3G","4G",
                     "宽带","专租线","固话","","合计",
                     "2G","3G","4G","固网","公共佣金",
                     "紧密外包费用","渠道补贴","终端补贴","卡成本","营业厅房租","水电物业费","广告宣传费","业务用品印制及材料费","营销费用小计",
            "办公费","车辆使用费","招待费","差旅费","通信费","行政费用小计", "",
            "铁塔租费（不含水电、油机发电）","网运水电费","代维费","网运房租及物业费","网运线客户接入成本","客户接入成本开通费","客户接入成本终端","网运费","网运修理费","网运行政费用","网运人工成本","网运成本合计",
            "",""]];
