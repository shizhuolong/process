jQuery(function(){
	...
	var _limit=20;
	var sql = "SELECT DEAL_DATE,AREA_NAME,UNIT_NAME,USER_NAME,HR_NO,SOURCE_CRE,HQ_CRE,UNIT_CRE,UNIT_MONEY FROM PMRT.TB_MRT_JCDY_QDXSJF_TOTAL " +
	...
	function init(sql){ 
		...
		head +="<tr class='attend_th'>" +
			...
			"<th class='attend_th'>人员名称</th><th class='attend_th'>hr编码</th><th class='attend_th'>原始积分</th>" +
...
function downsAll(){
	...
	var showtext="Sheet";
	   ...
	   var _head=['账期','地市','营服中心','人员名称','hr编码','原始积分','渠道调节积分','区域调节积分','积分金额'];
