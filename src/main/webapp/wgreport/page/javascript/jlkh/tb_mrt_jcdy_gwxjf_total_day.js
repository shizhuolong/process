jQuery(function(){
	var cols = ["area_name","unit_name","user_name","hr_no",
	            "gwkdxf","gwdown10m","gwup10m","gyrh","alljf","hq_cre","unit_cre","unit_money"];
	//excel导出
	...
	var sql = "SELECT T.AREA_NAME,T.UNIT_NAME,T.USER_NAME,T.HR_NO,SUM(T.GWKDXF) AS GWKDXF," +
			"SUM(T.GWDOWN10M) AS GWDOWN10M,SUM(T.GWUP10M) AS GWUP10M,SUM(T.GYRH) AS GYRH," +
			"SUM(T.ALLJF) AS ALLJF,SUM(T.HQ_CRE) AS HQ_CRE,SUM(T.UNIT_CRE) AS UNIT_CRE,SUM(T.UNIT_MONEY) AS UNIT_MONEY " +
