jQuery(function(){
	var cols = ["deal_date","area_name","unit_name","user_name","hr_no","g2sll","swsll","g3sll","g4sll","kdsll","allsll","g2jf","swjf","g3jf","g4jf","gwjf","kdxfjf","jtzzsrjf","ztjf","hjxsjf","hq_alljf","unit_alljf","base_sljf","fw_jf","zzyw_jf","sl_alljf","sl_svr_all_cre","unit_sl_alljf","wx_cre","wx_svr_cre","wx_unit_cre","all_jf","all_jf_money" ];
	//excel导出
	...
	var _limit=15;
	var sql = "SELECT DEAL_DATE,AREA_NAME,UNIT_NAME,USER_NAME,HR_NO,G2SLL,SWSLL,G3SLL,G4SLL,KDSLL,ALLSLL,G2JF," +
			"SWJF,G3JF,G4JF,GWJF,KDXFJF,JTZZSRJF,ZTJF,HJXSJF,HQ_ALLJF,UNIT_ALLJF,BASE_SLJF,FW_JF,ZZYW_JF,SL_ALLJF," +
			"SL_SVR_ALL_CRE,UNIT_SL_ALLJF ,WX_CRE,WX_SVR_CRE,WX_UNIT_CRE,ALL_JF,ALL_JF_MONEY FROM PMRT.TB_JCDY_JF_ALL_MON " +
	...
	function init(sql){ 
		...
		head +="<tr class='attend_th'>" +
			...
			"<th class='attend_th'>人员姓名</th><th class='attend_th'>hr编码</th><th class='attend_th'>2g发展量</th>" +
			...
			"<th class='attend_th'>固网发展积分</th><th class='attend_th'>宽带续费积分</th><th class='attend_th'>集团专租线积分</th>" +
			...
			"<th class='attend_th'>区域调节受理积分</th><th class='attend_th'>维系积分</th><th class='attend_th'>维系服务积分</th><th class='attend_th'>维系区域积分</th><th class='attend_th'>总积分</th><th class='attend_th'>总积分金额</th>" +
		"</tr>";
	...
	$("#search").click(function(){   
		...
		var fsql = getSelect();
		var sql = "SELECT DEAL_DATE,AREA_NAME,UNIT_NAME,USER_NAME,HR_NO,G2SLL,SWSLL,G3SLL,G4SLL,KDSLL,ALLSLL,G2JF,SWJF," +
				"G3JF,G4JF,GWJF,KDXFJF,JTZZSRJF,ZTJF,HJXSJF,HQ_ALLJF,UNIT_ALLJF,BASE_SLJF,FW_JF,ZZYW_JF,SL_ALLJF," +
				"SL_SVR_ALL_CRE,UNIT_SL_ALLJF ,WX_CRE,WX_SVR_CRE,WX_UNIT_CRE,ALL_JF,ALL_JF_MONEY FROM PMRT.TB_JCDY_JF_ALL_MON " +
...
function downsAll(){
	...
	var showtext="Sheet";
	   ...
	   var _head=['账期','地市','基层单元','人员姓名','hr编码','2g发展量','上网卡发展量','3g发展量','4g发展量','宽带发展量','总受理量','2g发展积分','上网卡发展积分','3g发展积分','4g发展积分','固网发展积分','宽带续费积分','集团专租线积分','质态积分','合计销售积分','渠道调节销售积分','区域调节销售积分','基础服务积分','服务积分','增值业务积分','总受理积分','服务调节受理积分','区域调节受理积分','维系积分','维系服务积分','维系区域积分','总积分','总积分金额'];
