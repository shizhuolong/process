...
/*jQuery(function(){
	var cols = ["deal_date","area_name","unit_name","user_name","hr_no",
	            ...
	            "sourcecode","hq_ratio","hq_cre","unit_ratio","unit_cre","unit_money"];
	//excel导出
	...
	*//**
	...
	function init(sql){ 
		...
		head +="<tr class='attend_th'>" +
				...
				"<th class='attend_th'>基层单元名称</th><th class='attend_th'>人员姓名</th>" +
				"<th class='attend_th'>HR编码</th><th class='attend_th'>用户编码</th>" +
				"<th class='attend_th'>用户号码</th><th class='attend_th'>入网时间</th>" +
				"<th class='attend_th'>操作人员编号</th><th class='attend_th'>部门编号</th>" +
				"<th class='attend_th'>套餐编号</th><th class='attend_th'>指标编码</th>" +
				"<th class='attend_th'>指标描述</th><th class='attend_th'>指标值</th>" +
				"<th class='attend_th'>发展人编码</th><th class='attend_th'>所属渠道</th>" +
				"<th class='attend_th'>渠道名称</th><th class='attend_th'>渠道编码</th>" +
				"<th class='attend_th'>原始积分</th><th class='attend_th'>原始积分编码</th>" +
...
function downsAll(){
	...
	var showtext="Sheet";
	   ...
	   var _head=['帐期','地市名称','基层单元','人员姓名','HR编码','用户编码','用户号码','入网时间','操作员工号','部门编码',
	              '套餐编码','指标编码','指标描述','指标值','发展人编码','所属渠道','渠道名称','渠道编码',
	              '原始积分','原始积分编码','渠道系数','乘渠道系数后积分','区域系数','乘区域系数后积分','积分金额'];
