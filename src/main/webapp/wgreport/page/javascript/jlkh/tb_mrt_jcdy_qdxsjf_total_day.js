jQuery(function(){
	...
	var sql = "SELECT T.AREA_NAME,T.UNIT_NAME,T.USER_NAME,T.HR_NO," +
			"SUM(T.SOURCE_CRE) AS SOURCE_CRE,SUM(T.HQ_CRE) AS HQ_CRE,SUM(T.UNIT_CRE) AS UNIT_CRE,SUM(T.UNIT_MONEY) AS UNIT_MONEY " +
