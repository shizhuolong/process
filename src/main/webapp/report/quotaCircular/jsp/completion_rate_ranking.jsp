...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/quotaCircular/js/completion_rate_ranking.js"></script>
<style type="text/css">
	...
	<input type="hidden" id=region value="<%=org.getRegionCode()%>">
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr>
					<td width="3%" align="right">排名标识：</td>
					<td width="5%">
						<select name="ranking" id="ranking" onchange="" class="default-text-input wper80">
								<option value=''>请选择</option>
								<option value="1" selected >前20</option>
								<option value="2" >后20</option>
						</select>
					</td>
					<td width="3%" align="right">排名依据：</td>
					<td width="7%">
						<select name="rankingBasis" id="rankingBasis" onchange="" class="default-text-input wper80">
								<option value=''>请选择</option>
								<option value="1" selected >收入完成</option>
								<option value="2" >积分完成</option>
								<option value="3" >毛利完成</option>
						</select>
					</td>
				</tr>
			</table>
