...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/quotaCircular/js/per_capita_integral.js"></script>
<style type="text/css">
				...
				<tr height="35px">
					...
					<td width="5%">
						<select name="countType" id="countType" onchange="" class="default-text-input wper80">
								...
								<option value="1" selected >人均原始积分</option>
								<option value="2" >人均计薪积分</option>
						</select>
					</td>
					<td width="3%">
