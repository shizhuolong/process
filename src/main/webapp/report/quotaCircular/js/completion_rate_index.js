var nowData = [];
var field=["DEAL_DATE","GROUP_ID_1_NAME","TASK_INCOME","TOTAL_FEE","INCOME_RATE","TASK_DEV","DEV_COUNT","DEVTASK_RATE","COST_BUDGET","COST_COUNT","COST_RATE","BUDGET_TASK","BUDGET_ML","ML_RATE"];
var title=[["账期","地市名称","收入排产目标（当年累计）","收入实际完成（当年累计）","收入累计完成率","积分排产目标（当年累计）","积分实际完成（当年累计）","积分累计完成率","成本预算（当年累计）","成本实际使用（当年累计）","成本累计完成率","毛利预算（当年累计）","毛利实际完成（当年累计）","毛利累计完成率"]];
var orderBy='';	
var report = null;
$(function() {
	listRegions();
...
function getSql(){
	var s="SELECT DEAL_DATE,                            "+
			...
			"       BUDGET_ML,                            "+
			"       ML_RATE                               "+
			"  FROM PMRT.TB_MRT_JF_ZB_COUNT_COMPLETEZB T  ";
	return s;
}
/////////////////////////下载开始/////////////////////////////////////////////
function downsAll(){
