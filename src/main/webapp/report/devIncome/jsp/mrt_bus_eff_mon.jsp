...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/mrt_bus_eff_mon.js?v=3"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="6%">营业厅编码：</td>
					<td width="15%">
						<input name="yyt_code" id="yyt_code" class="default-text-input wper80"/>
					</td>
					<td width="6%">营业厅名称：</td>
					<td width="15%">
