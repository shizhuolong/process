...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/terminal_sales_month.js"></script>
</head>
	...
	<form id="searchForm" method="post">
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr>
					...
					<td width="5%" align="right">是否割接：</td>
					<td width="15%">
						<select name="flag" id="flag" class="default-text-input wper80">
								<option value=''>请选择</option>
