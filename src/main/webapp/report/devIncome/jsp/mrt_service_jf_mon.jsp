...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/mrt_service_jf_mon.js"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr>
					...
					<td width="4%" align="right">指标描述：</td>
					<td width="10%">
						<input name="itemDesc" id="itemDesc"  class="default-text-input wper80">
					</td>
				</tr>
			</table>
		</form>
