...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/ts_r_cbss_update.js?v=4"></script>
<style type="text/css">
  form {margin-right: 20px;}
  table {margin:10px;width:880px;}
  a {cursor:pointer;}
  th {background: none repeat scroll 0 0 #ffecc8;color:#d28531;border:1px solid #d28531;height:40px;width:20px;}
  td {height:30px;width:50px;border:1px solid #d28531}
</style>
</head>
