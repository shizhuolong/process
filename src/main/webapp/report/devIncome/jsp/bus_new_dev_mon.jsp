...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/bus_new_dev_mon.js?v=9"></script>
</head>
	...
	<form id="searchForm" method="post">
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="10%" align="right">厅类型：</td>
					<td width="15%">
