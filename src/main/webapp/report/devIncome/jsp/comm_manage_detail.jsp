...
<body class="" style="overflow-x:auto;">
	...
	<input type="hidden" id="comm_name" value="<%=request.getParameter("comm_name")%>">
	<input type="hidden" id="tablecode" value="<%=request.getParameter("tablecode")%>">
