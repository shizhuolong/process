...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/income_and_target_month.js?v=3"></script>
</head>
<style>
	...
	<form id="searchForm" method="post">
			...
			<table width="60%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="10%">
						<input type="text" readonly class="Wdate default-text-input wper20"  style="width:60px;"
