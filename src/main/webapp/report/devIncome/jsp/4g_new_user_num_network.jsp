...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/4g_new_user_num_network.js"></script>
<style type="text/css">
	...
	<input type="hidden" id=region value="<%=org.getRegionCode()%>">
		<form id="searchForm" method="post" style="width:60%">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					<td width="10%" style="padding-left: 10px;" align="right">账期：</td>
					<td width="30%">
