...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/wyg_zc_mon.js"></script>
</head>
	...
	<input type="hidden" id="hrId" value="<%=user.getHrId()%>">
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				...
				<tr>
					<td width="8%" style="text-align:right;">渠道名称：</td>
					<td width="10%">
						<input class="default-text-input wper80" name="channlName" type="text" id="channlName"/>
					</td>
					<td width="5%" style="text-align:right;">姓名：</td>
					<td width="15%">
						<input class="default-text-input wper80" name="userName" type="text" id="userName"/>
					</td>
					<td width="8%" style="text-align:right;">品牌：</td>
					<td width="15%">
						<select name="manu" id="manu" onchange="" class="default-text-input wper80">
								<option value=''>请选择</option>
						</select>
					</td>
				</tr>
