...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/unit_pay_cost_classify.js?v=1"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="5%" style="text-align:right;">营业厅编码：</td>
					...
					<td width="3%">
						<a class="default-btn" href="#" id="exporDetailtBtn" onclick="downsDetailAll()">导出明细</a>
					</td>
				</tr>
				<tr height="35px">
					<td width="5%" style="text-align:right;">经营模式：</td>
					<td width="10%">
						<select name="operType" id="operType" onchange="" class="default-text-input wper80">
								<option value='自营'>自营</option>
						</select>
					</td>
					<td width="5%" style="text-align:right;">缴费方式：</td>
					<td width="10%">
						<select name="payMode" id="payMode" onchange="" class="default-text-input wper80">
								<option value=''>请选择</option>
						</select>
					</td>
					<td width="5%" style="text-align:right;">营业员工位：</td>
					<td width="10%"><input class="default-text-input wper80" name="userCode" type="text" id="userCode" /></td>
				</tr>
			</table>
		</form>
