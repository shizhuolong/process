...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/wg_bss_manual_comm_diff.js?v=10"></script>
</head>
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="26%">
						...
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM',isShowClear:false})" value="<%=dealDate%>" id="startDate"> 至 
						<input type="text"  class="Wdate default-text-input wper40" readonly="readonly"
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM',isShowClear:false})" value="<%=dealDate%>" id="endDate">
					</td>
					<td width="5%" style="text-align:right;">渠道名称：</td>
					<td width="10%">
						<input class="default-text-input wper80" name="chanlName" type="text" id="chanlName"/>
					</td>
					<td width="5%" style="text-align:right;">渠道属性：</td>
					<td width="10%">
