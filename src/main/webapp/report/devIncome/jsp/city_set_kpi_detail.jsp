...
<%
	...
	String deal_date = new SimpleDateFormat("yyyyMM").format(ca.getTime());
%>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/devIncome/js/city_set_kpi_detail.js"></script>
</head>
