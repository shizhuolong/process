...
function getSql(orgLevel,where){
	...
	if(orgLevel==1){
		...
		"       CASE WHEN SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0)) <> 0                                                                                                                                                                                                                                                    "+
		"            THEN ROUND((SUM(NVL(T.KC_NUM1, 0)) + SUM(NVL(T.KC_NUM3, 0))) / ((SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0))) / TO_CHAR(LAST_DAY(TO_DATE(T.DEAL_DATE, 'YYYYMM')), 'dd') * 7), 2)                                                                                                                         "+
		"            ELSE 0 END KCALL_CYCLE,                                                                                                                                                                                                                                                                                          "+
		...
		"       PODS.GET_RADIX_POINT(CASE WHEN SUM(NVL(T3.SALE_NUM1, 0)) + SUM(NVL(T3.SALE_NUM3, 0)) <> 0                                                                                                                                                                                                                             "+
		"                                 THEN (SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0)) - (SUM(NVL(T3.SALE_NUM1, 0)) + SUM(NVL(T3.SALE_NUM3, 0)))) * 100 / (SUM(NVL(T3.SALE_NUM1, 0)) + SUM(NVL(T3.SALE_NUM3, 0)))                                                                                                        "+
		"                                 ELSE 0 END || '%', 2) SALEALL_DB,                                                                                                                                                                                                                                                           "+
		"       PODS.GET_RADIX_POINT(CASE WHEN SUM(NVL(T4.JH_NUM1, 0)) + SUM(NVL(T4.JH_NUM3, 0)) <> 0                                                                                                                                                                                                                                 "+
		"                                 THEN (SUM(NVL(T.JH_NUM1, 0)) + SUM(NVL(T.JH_NUM3, 0)) - (SUM(NVL(T4.JH_NUM1, 0)) + SUM(NVL(T4.JH_NUM3, 0)))) * 100 / (SUM(NVL(T4.JH_NUM1, 0)) + SUM(NVL(T4.JH_NUM3, 0)))                                                                                                                    "+
		"                                 ELSE 0 END || '%', 2) AS JHALL_DB,                                                                                                                                                                                                                                                          "+
		"       PODS.GET_RADIX_POINT(CASE WHEN SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0)) <> 0                                                                                                                                                                                                                             "+
		"                                 THEN (SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0)) - (SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0)))) * 100 / (SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0)))                                                                                                        "+
		"                                 ELSE 0 END || '%', 2) AS SALEALL_DB1,                                                                                                                                                                                                                                                       "+
		"       PODS.GET_RADIX_POINT(CASE WHEN SUM(NVL(T4.KC_NUM1, 0)) + SUM(NVL(T4.KC_NUM3, 0)) <> 0                                                                                                                                                                                                                                 "+
		"                                 THEN (SUM(NVL(T.KC_NUM1, 0)) + SUM(NVL(T.KC_NUM3, 0)) - (SUM(NVL(T4.KC_NUM1, 0)) + SUM(NVL(T4.KC_NUM3, 0)))) * 100 / (SUM(NVL(T4.KC_NUM1, 0)) + SUM(NVL(T4.KC_NUM3, 0)))                                                                                                                    "+
		"                                 ELSE 0 END || '%', 2) AS KCALL_DB,                                                                                                                                                                                                                                                          "+
		"       PODS.GET_RADIX_POINT(CASE WHEN (CASE WHEN SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0)) <> 0                                                                                                                                                                                                                  "+
		"                                            THEN ROUND((SUM(NVL(T4.KC_NUM1, 0)) + SUM(NVL(T4.KC_NUM3, 0))) / ((SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0))) / TO_CHAR(LAST_DAY(TO_DATE(T4.DEAL_DATE, 'YYYYMM')), 'dd') * 7), 2)                                                                                    "+
		"                                            ELSE 0 END)   <>0                                                                                                                                                                                                                                                                "+
		"                                 THEN ((CASE WHEN SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0)) <> 0                                                                                                                                                                                                                   "+
		"                                            THEN ROUND((SUM(NVL(T.KC_NUM1, 0)) + SUM(NVL(T.KC_NUM3, 0))) / ((SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0))) / TO_CHAR(LAST_DAY(TO_DATE(T.DEAL_DATE, 'YYYYMM')), 'dd') * 7), 2)                                                                                         "+
		"                                            ELSE 0 END) -                                                                                                                                                                                                                                                                    "+
		"                                       (CASE WHEN SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0)) <> 0                                                                                                                                                                                                                 "+
		"                                             THEN ROUND((SUM(NVL(T4.KC_NUM1, 0)) + SUM(NVL(T4.KC_NUM3, 0))) / ((SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0))) / TO_CHAR(LAST_DAY(TO_DATE(T4.DEAL_DATE, 'YYYYMM')), 'dd') * 7), 2)                                                                                   "+
		"                                             ELSE 0 END))*100 /                                                                                                                                                                                                                                                              "+
		"                                        (CASE WHEN SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0)) <> 0                                                                                                                                                                                                                "+
		"                                              THEN ROUND((SUM(NVL(T4.KC_NUM1, 0)) + SUM(NVL(T4.KC_NUM3, 0))) / ((SUM(NVL(T4.SALE_NUM1, 0)) + SUM(NVL(T4.SALE_NUM3, 0))) / TO_CHAR(LAST_DAY(TO_DATE(T4.DEAL_DATE, 'YYYYMM')), 'dd') * 7), 2)                                                                                  "+
		"                                              ELSE 0 END)                                                                                                                                                                                                                                                                    "+
		"                                  ELSE 0 END || '%', 2) AS KCALL_CYCLE_DB                                                                                                                                                                                                                                                    "+
		...
		" GROUP BY T.GROUP_ID_0, T.DEAL_DATE,T4.DEAL_DATE                                                                                                                                      ";
	}else if(orgLevel==2){
		...
		"                                 (SUM(NVL(T1.SALE_NUM1, 0)) + SUM(NVL(T1.SALE_NUM3, 0)))) * 100 /                                                                                                                                              "+
		...
		"                                 (SUM(NVL(T.KC_NUM1, 0)) + SUM(NVL(T.KC_NUM3, 0)) -                                                                                                                                                            "+
		"                                 (SUM(NVL(T1.KC_NUM1, 0)) + SUM(NVL(T1.KC_NUM3, 0)))) * 100 /                                                                                                                                                  "+
		...
		"                                 (SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0)) -                                                                                                                                                        "+
		"                                 (SUM(NVL(T2.SALE_NUM1, 0)) + SUM(NVL(T2.SALE_NUM3, 0)))) * 100 /                                                                                                                                              "+
		...
		"                              2) SALEALL_TB,                                                                                                                                                                                                   "+
		"         PODS.GET_RADIX_POINT(CASE                                                                                                                                                                                                             "+
		"                                WHEN SUM(NVL(T3.SALE_NUM1, 0)) + SUM(NVL(T3.SALE_NUM3, 0)) <> 0 THEN                                                                                                                                           "+
		"                                 (SUM(NVL(T.SALE_NUM1, 0)) + SUM(NVL(T.SALE_NUM3, 0)) -                                                                                                                                                        "+
		"                                 (SUM(NVL(T3.SALE_NUM1, 0)) + SUM(NVL(T3.SALE_NUM3, 0)))) * 100 /                                                                                                                                              "+
		"                                 (SUM(NVL(T3.SALE_NUM1, 0)) + SUM(NVL(T3.SALE_NUM3, 0)))                                                                                                                                                       "+
		"                                ELSE                                                                                                                                                                                                           "+
		"                                 0                                                                                                                                                                                                             "+
		"                              END || '%',                                                                                                                                                                                                      "+
		"                              2) SALEALL_DB,                                                                                                                                                                                                   "+
		...
		" GROUP BY T.GROUP_ID_1, T.GROUP_ID_1_NAME, T.DEAL_DATE,T4.DEAL_DATE";
