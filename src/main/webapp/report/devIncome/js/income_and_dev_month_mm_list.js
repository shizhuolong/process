...
var field=[
	...
	$(function() {
		report = new LchReport({
			title : [
					["小区名称","2G出账用户数","","","3G出账用户数","","","4G出账用户数","","","宽带出账用户数","","","2G新发展用户数","","","3G新发展用户数","","","4G新发展用户数","","","宽带新发展用户数","","","专租线新发展用户数(不含ICT)","","","固话新发展用户数","","","2G出账收入","","","3G出账收入","","","4G出账收入","","","宽带出账收入","","","专租线出账收入(不含ICT)","","","固话出账收入","",""]
,["",
"上月","本月","环比",
"上月","本月","环比",
"上月","本月","环比",
...
"上月","本月","环比"]
	...
	function downsAll() {
		...
		var title=[["营销架构","","","","","","","","帐期","2G出账用户数","","","3G出账用户数","","","4G出账用户数","","","宽带出账用户数","","","2G新发展用户数","","","3G新发展用户数","","","4G新发展用户数","","","宽带新发展用户数","","","专租线新发展用户数(不含ICT)","","","固话新发展用户数","","","2G出账收入","","","3G出账收入","","","4G出账收入","","","宽带出账收入","","","专租线出账收入(不含ICT)","","","固话出账收入","",""],
