		...
		getSubRowsCallBack:function($tr){
			...
			if($tr){
				...
				if(orgLevel==1){//省
					...
					provinceSql=' union all select t.group_id_0 ROW_ID,\'全省合计\' ROW_NAME,'+sumSql+' from PMRT.TAB_MRT_TARGET_HQ_DAY partition(P'+qdate+') t ';
			...
			var sql='select '+preField+','+sumSql+' from PMRT.TAB_MRT_TARGET_HQ_DAY partition(P'+qdate+') t ';
...
function showAgentList($tr){
	...
	var url=$("#ctx").val()+"/report/devIncome/jsp/mrt_target_hq_day_list.jsp?agentId="+agentId+"&unitId="+unitId+"&month="+month+"&agentType="+perType;
...
function downsAll() {
	...
	var sql = 'select ' + preField + ',' + fieldSql
			+ ' from PMRT.TAB_MRT_TARGET_HQ_DAY partition(P'+qdate+')  t ';
	...
	showtext = '全业务渠道分类日报-' + qdate;
	var title=[["营销架构","","","","","","","","日期","2G当日发展","","","","","","","3G当日发展","","","","","","","","4G当日发展","","","","","","","","","固网宽带当日发展","","","","","","2G累计发展","","","","","","","3G累计发展","","","","","","","","4G累计发展","","","","","","","","","固网宽带累计发展","","","","","","2G累计收入","","","","","","","3G累计收入","","","","","","","","4G累计收入","","","","","","","","","固网宽带累计收入","","","","","","集客专租线发展","","专租线收入","固话发展量","","固话收入","移网在网用户数","",""],
