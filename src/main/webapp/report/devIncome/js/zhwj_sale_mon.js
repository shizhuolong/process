...
var orderBy="";
$(function(){
	$("#month").val(getMaxDate("PMRT.TB_MRT_BUS_HALL_ZHWJ_SALE_MON"));
...
function downsAll() {
	...
	title=[["账期","地市名称","主厅编码","下挂厅编码","营业厅名称","经营模式","用户标识","虚拟号码","捆绑号码","用户名称","客户地址","装机地址","联系方式","套餐","入网时间","离网时间","局站","接入方式","宽带速率","办理产品ID","办理产品名称","产品说明","办理时间","系统标识(BS/CB)"]];
