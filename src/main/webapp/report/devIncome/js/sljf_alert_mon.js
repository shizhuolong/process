var field=["ALL_SLL","SL_JF","FW_JF","ZZ_JF","ALL_SL_CRE","ALL_UNIT_CRE","ALL_UNIT_MONEY","LS_ALL_SLL","LS_SL_JF","LS_FW_JF","LS_ZZ_JF","LS_ALL_SL_CRE","LS_ALL_UNIT_CRE","LS_ALL_UNIT_MONEY","SL_CRE_RATE","SL_SLL_RATE"];
var orderBy='';	
$(function(){
	var report=new LchReport({
		title:[
["组织架构","本月受理量","本月基础积分","本月服务积分","本月增值业务积分","本月受理原始积分","本月调节受理积分","本月积分提成","上月受理量","上月基础积分","上月服务积分","上月增值业务积分","上月受理原始积分","上月调节受理积分","上月积分提成","总积分波动","受理量波动"]
		],
...
function getSumSql(field) {
	...
	for (var i = 0; i < field.length; i++) {
		...
		if(field[i]=='SL_CRE_RATE'){
			s += "trim(to_char((SUM(" + field[4]
			+ ")-sum("+ field[11]+"))/sum("+ field[11]+"),'9g999g999g999g999g999g999g999g999g990d00')) " + field[i];
		}else if(field[i]=='SL_SLL_RATE'){
			s += "trim(to_char((SUM(" + field[0]
			+ ")-sum("+ field[7]+"))/sum("+ field[7]+"),'9g999g999g999g999g999g999g999g999g990d00')) " + field[i];
		}else{
...
function downsAll() {
	...
	var title=[["地市名称","营服名称","姓名","HR编码","本月账期","上月账期","本月受理量","本月基础积分","本月服务积分","本月增值业务积分","本月受理原始积分","本月调节受理积分","本月积分提成","上月受理量","上月基础积分","上月服务积分","上月增值业务积分","上月受理原始积分","上月调节受理积分","上月积分提成","总积分波动","受理量波动"]];
