...
$(function() {
	...
	field=["DEAL_DATE","GROUP_ID_1_NAME","UNIT_NAME","HR_ID","NAME","USER_ROLE","SUBSCRIPTION_ID","DEVICE_NUMBER","NET_TYPE","TOTAL_FEE","LAST_12","HQ_CHAN_CODE"];
	title=[["账期","地市名称","营服名称","HR编码","姓名","角色","用户编号","用户号码","用户类型",year+"年拍照用户今年累计收入",year+"年拍照用户去年12月收入","渠道编码"]];
	listRegions();
...
function getSql(){
	...
	var s="SELECT T.DEAL_DATE,                      "+
			...
			"       T.SUBSCRIPTION_ID,                "+
			"       T.DEVICE_NUMBER,                  "+
			"       DECODE(T.NET_TYPE,01,'2G',02,'3G',03,'3G上网卡',04,'4G') AS NET_TYPE,                       "+
			"       T.TOTAL_FEE,                      "+
			"       T.LAST_12,                        "+
			"       T.HQ_CHAN_CODE                    "+
			"  FROM PODS.TB_ODS_JCDY_INCOME_ALL_MON PARTITION(P"+dealDate+") T ";
	return s;
}
/////////////////////////下载开始/////////////////////////////////////////////
function downsAll(){
