var nowData = [];
	var field = [ "GROUP_ID_4_NAME", "ACCT_2_CHW_NUM", "ACCT_2_SHW_NUM",
			...
			"SR_FTTH_NUM", "SR_10M_NUM", "SR_BB_NUM", "DEV_ZZX_NUM","DEV_ICT_NUM",
			"SR_ZZX_NUM","SR_ICT_NUM","DEV_NET_NUM","SR_NET_NUM", "CALL_TIME_2G", "MOU_2G", "FLOW_2G", "AVG_FLOW_2G",
		...
		report = new LchReport({
			title : [
					...
					[ "渠道（小区）名称", "长话王", "市话王", "包打王", "流量王", "极速卡", "其他",
							...
							"全国套餐存费送机", "全国套餐合约惠机", "全国套餐存费送费", "其他", "合计",/*4G*/
							"ADSL", "LAN", "EOC", "FTTH", "其中10M及以上", "合计",
							"专租线发展(不含ICT)","ICT", "专租线收入(不含ICT)","ICT","固话发展量","固话收入","通话分钟数", "MOU", "流量", "户均流量",
