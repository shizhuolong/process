var nowData = [];
var title=[["账期","分公司","渠道经理姓名","当月累计宽带预存款余额≤30元用户数","当月累计宽带预存款余额≤30元续费用户数（续费用户数）","当月累计续费率","当月累计续费率全省排名","当月累计监控停机用户数","当月累计拆机用户数","当年累计宽带预存款余额≤30元用户数","当月累计宽带预存款余额≤30元续费用户数（续费用户数）","当年累计续费率","当年累计续费率全省排名","当年累计监控停机用户数","当年累计拆机用户数","公共池全渠道公开待续费用户数（状态为监控停机用户数）"]];
