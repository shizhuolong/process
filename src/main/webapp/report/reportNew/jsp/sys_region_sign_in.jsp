...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/sys_region_sign_in.js"></script>
<style type="text/css">
	...
	<input type="hidden" id="hr_id" value="<%=user.getHrId()%>">
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
					<td width="3%" style="padding-left: 1px;" align="right">时间：</td>
					<td width="8%">
