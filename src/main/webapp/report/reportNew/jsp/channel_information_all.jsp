...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/channel_information_all.js"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
                    ...
                    <td width="3%" style="text-align:right;">合作年份：</td>
                    <td width="8%">
                        <select name="hz_year" id="hz_year" class="default-text-input wper100">
