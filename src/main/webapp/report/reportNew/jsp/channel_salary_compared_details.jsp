...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/channel_salary_compared_details.js"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
                    ...
                    <td width="6%" align="right">渠道经理名字：</td>
                    <td width="8%">
                        <input class="default-text-input wper80" name="manageName" type="text" id="manageName"/>
                    </td>
                    <td width="5%">
