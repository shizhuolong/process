...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/fixed_line_commission_report.js"></script>
<style type="text/css">
		...
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="16%">
						<input type="text" style="width:100px" class="Wdate" id="start_deal_date" readonly="readonly" value="<%=dealDate %>"  onclick="WdatePicker({isShowClear:false,skin:'whyGreen',dateFmt:'yyyyMM'})"/>
                        至
                        <input type="text" style="width:100px" class="Wdate" id="end_deal_date" readonly="readonly" value="<%=dealDate %>"  onclick="WdatePicker({isShowClear:false,skin:'whyGreen',dateFmt:'yyyyMM'})"/>
					</td>
                    ...
                    <td width="3%" style="text-align:right;">增存量：</td>
                    <td width="8%">
                        <select name="c4" id="c4" class="default-text-input wper100">
