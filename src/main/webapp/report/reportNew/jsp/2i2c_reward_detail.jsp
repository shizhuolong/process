...
<script type="text/javascript" src="<%=request.getContextPath()%>/report/reportNew/js/2i2c_reward_detail.js?v=1"></script>
<style type="text/css">
	...
	<input type="hidden" id="hr_id" value="<%=user.getHrId()%>">
		<form id="searchForm" method="post" style="width:100%">
			<table style="width:100%;margin: 10px 0; border:none;">
				<tr height="35px">
				    <td width="6%" style="padding-left: 1px;" align="right">首冲时间：</td>
                    <td width="17%">
                    ...
                    <td width="5%" style="text-align:right;">订单ID：</td>
                    <td width="8%">
                        <input class="default-text-input wper80" name="orderId" type="text" id="orderId"/>
                    </td>
                    <td width="5%">
				...
				<tr>				    
                    ...
                    <td width="5%" style="text-align:right;">用工性质：</td>
                    <td width="8%">
                        <input type="text" name="empType" id="empType" class="default-text-input wper80"></input>
                    </td>
				</tr>
			</table>
		</form>
