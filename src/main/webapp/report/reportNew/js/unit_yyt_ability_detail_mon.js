...
function downsAll() {
	...
	if(busiMode!=''){
		where+=" AND T1.BUSI_MODE = '"+busiMode+"'";
	}
...
function getSql(where,level){
	...
	if(level==1){
		...
		"  JOIN (SELECT * FROM (SELECT   UNIT_NAME,                                                                     "+
		"                      YYT_CODE,                                                                                     "+
		"                      YYT_NAME,                                                                                     "+
		"                      YYT_ADDR,                                                                                     "+
		"                      HQ_CHAN_CODE,                                                                                 "+
