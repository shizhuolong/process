...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/order2i2c/js/province_order_list.js?v=6"></script>
	...
	<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;font-size:100%;">
				<tr height="35px">
					...
					<td width="13%">
						<select class="default-text-input wper80" name="regionCode"  id="regionCode">
						</select>
					</td>
