...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/channelManagement/js/portal_mag_person_list.js"></script>
...
<body class="easyui-layout">
	...
	<div data-options="region:'west',split:false,title:'营业厅厅主任'" style="width:220px;padding:10px;">
