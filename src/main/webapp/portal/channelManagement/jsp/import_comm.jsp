...
<%
	...
	String headRows=request.getParameter("headRows");
...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/portal/channelManagement/js/import_comm.js?v=1"></script>
			...
			<div class="main-block">
				...
				<div id="chose-sender">
					...
					<form id="uploadForm" name="mainForm"
						...
						<input type="hidden" id="headRows" name="headRows" value="<%=headRows%>"/>
