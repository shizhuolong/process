...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/portal/channelManagement/js/import_terminal_sales.js"></script>
	<style>
		th {
			...
			<div class="main-block">
				...
				<div id="chose-sender">
					...
					<form id="uploadForm" name="mainForm"
						action="<%=request.getContextPath()%>/channelManagement/terminalSales_importToTemp.action"
