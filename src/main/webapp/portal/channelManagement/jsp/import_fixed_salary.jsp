...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/portal/channelManagement/js/import_fixed_salary.js"></script>
					...
					<form id="uploadForm" name="mainForm"
						...
						<table cellspacing="0" width="100%">
							<tr>
								...
								<td colspan='2'><span style="display:inline-block;">返回查询页面点击导出，导出对应的EXCEL数据模板。 
								</td>
							</tr>
							<tr>
