...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/portal/channelManagement/js/import_deviceSale.js"></script>
				...
				<div id="chose-sender">
					...
					<form id="uploadForm" name="mainForm"
						...
						<table cellspacing="0" width="100%">
							...
							<tr>
								<td colspan="4">
								    <span style="color:red;font-size:15px;">(注意事项：此导入模块用于营业厅终端日销量导入，必须于每日10点半以前导入；上传的模板必须要与模板下载的一致，表头不能有多列或少列；单元格必须要有实线边框；模板中不能有公式，拉伸或者特殊格式；数字列长度如果超过7位，请设置为文本格式，否则会被Excel转化为科学计数法；上传出现错误时可以将数据复制到页面下载的模板中再上传。)</span>
								</td>
							</tr>
						</table>
					</form>
