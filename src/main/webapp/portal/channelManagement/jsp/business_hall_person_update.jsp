	...
	<div class="default-dt" style="width: 420px;">
		<div class="sticky-wrap" style="height: 150px;">
			<form id="update" method="POST">
				...
				<tr>
					<td>姓名:</td>
					<td><input type="text" required="true" class="easyui-validatebox" missingMessage="姓名不能为空" name="name" id="name"></td>
				</tr>
				<tr>
					<td>工位:</td>
					<td><input type="text" required="true" class="easyui-validatebox" missingMessage="工位不能为空" readonly="true" name="user_code"  id="user_code"></td>
				</tr>
				<tr>
					<td>HR编码:</td>
				...
				<tr>
					<td>营服中心:</td>
					<td><input type="text" required="true" class="easyui-validatebox" missingMessage="营服中心不能为空" name="unit_name" id="unit_name"></td>
				</tr>
				<tr>
