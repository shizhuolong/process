...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/channelManagement/js/chnl_person_list.js?v=2"></script>
</head>
<body class="easyui-layout">
	...
	<div data-options="region:'west',split:false,title:'小区代理商人员'" style="width:220px;padding:10px;">
		<div id="ztree" class="ztree"></div>
	</div>
	<div data-options="region:'center',title:'小区代理商人员'">
		<div id="container">
          	...
          	<table width="100%" style="margin:10px 0;">
          	    <tr height="35px">
					...
					<td width="15%">
						...
						onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM',isShowClear:false})" value="<%=dealDate%>" id="deal_date"/>
					</td>
					<td width="6%" style="text-align: right;">小区编码：</td>
                    <td width="15%"><input class="default-text-input wper80" id="std_6_id" name="std_6_id" type="text"/></td>
				 </tr>	
                 <tr height="35px">
                    <td width="6%" style="text-align: right;">小区名称：</td>
                 ...
                 <tr height="35px">
                    <td width="6%" style="text-align: right;">渠道名称：</td>
