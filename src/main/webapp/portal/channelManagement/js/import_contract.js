...
function downloadFile() {
	window.location.href=$("#ctx").val()+"/contract/import-contract!downfile.action";
}
...
function complete(){
	...
	var flag=checkOptions();
	 if(flag){
		...
		var action=$("#ctx").val()+"/contract/import-contract!importToTemp.action?fileType="+$("#fileType").val();
...
function toBack(){
	 window.location.href=$("#ctx").val()+"/portal/channelManagement/jsp/import_contract_list.jsp";
}
