...
function downloadFile() {
	window.location.href=$("#ctx").val()+"/channelManagement/ironOwn_downfile.action";
}
...
function complete(){
	...
	var flag=checkOptions();
	 if(flag){
		...
		var action=$("#ctx").val()+"/channelManagement/ironOwn_importToTemp.action?fileType="+$("#fileType").val();
...
function toBack(){
	 window.location.href=$("#ctx").val()+"/portal/channelManagement/jsp/import_iron_own_list.jsp";
}