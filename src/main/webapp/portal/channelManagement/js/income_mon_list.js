var nowData = [];
var title=[["账期","分公司","2G主营业务收入（指标序号：C1）","","","","","","3G主营业务收入（指标序号：C2）","","","","","","4G主营业务收入（指标序号：C3）","","","","","","固网主营业务收入不含ICT、IDC云计算、专租线（指标序号：C4）","","","","","","专租线主营业务收入（不含ICT）宽带主营业务收入（指标序号：C5）","","","","","","移动网主营业务收入（指标序号：C6）","","","","","","固网主营业务收入（指标序号：C7）","","","","","","总体主营业务收入(指标序号：C8) C6+C7","","","","",""],
