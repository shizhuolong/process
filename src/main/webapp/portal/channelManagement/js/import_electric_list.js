var nowData = [];
var title=[["账期","地市","是否入库","站址或局房编码","期末预提余额","成本中心代码","本月预提标准","月末预提起日期","增值税","铁塔公司站点","铁塔公司交纳水电费","最近的水电支付单价","本月用量或预计用量"]];
var field=["DEAL_DATE","GROUP_ID_1_NAME","IS_IN_UNIT","ROOM_ADDR","END_YT_MONEY","AC_PREFIX","THIS_MON_YT","END_MON_DATE","ZZ_FAX","OIL_COMPANY","WATER_FEE","PER_WATER_FEE","THIS_NUM"];
var report = null;
var downSql="";
$(function() {
