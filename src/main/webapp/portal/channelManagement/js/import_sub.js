...
function downloadFile() {
	window.location.href=$("#ctx").val()+"/sub/import-sub!downfile.action";
}
...
function complete(){
	...
	var flag=checkOptions();
	 if(flag){
		...
		var action=$("#ctx").val()+"/sub/import-sub!importToTemp.action?fileType="+$("#fileType").val();
...
function toBack(){
	 window.location.href=$("#ctx").val()+"/portal/channelManagement/jsp/import_sub_list.jsp";
}