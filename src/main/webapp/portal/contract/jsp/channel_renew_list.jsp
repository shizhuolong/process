...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/contract/js/channel_renew_list.js?v=25"></script>
							...
							<div class="main-block">
								...
								<table id="sm-payment-order-apply" style="width: 100%;">
									<tr>
					                    ...
					                    <td width="8%">
					                        <input type="text" style="width:100px" class="Wdate" id="startDate" readonly="readonly" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM'})"/>
					                    </td>
					                    <td width="6%" style="padding-left: 1px;" align="right">结束月份：</td>
					                    <td width="8%">
					                        <input type="text" style="width:100px" class="Wdate" id="endDate" readonly="readonly"  onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyyMM'})"/>
					                    </td>
