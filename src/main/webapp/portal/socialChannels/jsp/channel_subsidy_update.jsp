...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/socialChannels/js/channel_subsidy_update.js"></script>
</head>
		...
		<div class="default-dt" >
			<div class="sticky-wrap" >
				<form id="add" method="POST">
				  <table>
						<tr>
							<td>渠道编码：</td><td><input style="margin-left: 12px;" type="text"  
								class="easyui-validatebox" 
								name="hqChanCode" id="hqChanCode" readOnly="readonly"/>
							</td>
						</tr>
						<tr>
