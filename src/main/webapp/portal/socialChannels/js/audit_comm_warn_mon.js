var field=["TOTAL_DEV","TOTAL_EFFECTIVE","TOTAL_JTNUM","TOTAL_XHNUM","TOTAL_SWNUM","TOTAL_JDNUM","LESS_96_DEV","LESS_96_EFFECTIVE","LESS_96_JTNUM","LESS_96_XHNUM","LESS_96_SWNUM","LESS_96_JDNUM","MORE_96_DEV","MORE_96_EFFECTIVE","MORE_96_JTNUM","MORE_96_XHNUM","MORE_96_SWNUM","MORE_96_JDNUM"];
...
$(function(){
	 ...
	 report=new LchReport({
		...
		getSubRowsCallBack:function($tr){
			...
			if(orgLevel<=4){
				groupBy=" GROUP BY UNIT_ID_"+(orgLevel-1)+",UNIT_ID_"+(orgLevel-1)+"_NAME,TOTAL_EFFECTIVE_LEV"+(orgLevel-1)+",LESS_96_EFFECTIVE_LEV"+(orgLevel-1)+",MORE_96_EFFECTIVE_LEV"+(orgLevel-1);
			}
...
function getSql(orgLevel){
	var fs="";
	if(orgLevel<=4){
        fs="SELECT UNIT_ID_"+(orgLevel-1)+" ROW_ID,UNIT_ID_"+(orgLevel-1)+"_NAME ROW_NAME,SUM(TOTAL_DEV) TOTAL_DEV, TOTAL_EFFECTIVE_LEV"+(orgLevel-1)+" TOTAL_EFFECTIVE,SUM(TOTAL_JTNUM) TOTAL_JTNUM, SUM(TOTAL_XHNUM) TOTAL_XHNUM,SUM(TOTAL_SWNUM) TOTAL_SWNUM,SUM(TOTAL_JDNUM) TOTAL_JDNUM"+
        ",SUM(LESS_96_DEV) LESS_96_DEV,LESS_96_EFFECTIVE_LEV"+(orgLevel-1)+" LESS_96_EFFECTIVE,SUM(LESS_96_JTNUM) LESS_96_JTNUM, SUM(LESS_96_XHNUM) LESS_96_XHNUM,SUM(LESS_96_SWNUM) LESS_96_SWNUM,SUM(LESS_96_JDNUM) LESS_96_JDNUM"+
        ",SUM(MORE_96_DEV) MORE_96_DEV,MORE_96_EFFECTIVE_LEV"+(orgLevel-1)+" MORE_96_EFFECTIVE,SUM(MORE_96_JTNUM) MORE_96_JTNUM,SUM(MORE_96_XHNUM) MORE_96_XHNUM,SUM(MORE_96_SWNUM) MORE_96_SWNUM,SUM(MORE_96_JDNUM) MORE_96_JDNUM "+
        "FROM YNPAY.TB_PAY_AUDIT_COMM_WARN_MON                                                                                                                                                                             ";
	}else{
		fs = "SELECT                                  "+
...
function getDownSql(){
	...
	"       UNIT_ID_1_NAME UNIT_ID_1_NAME,        "+
	"       UNIT_ID_2_NAME UNIT_ID_2_NAME,        "+
	"       UNIT_ID_3_NAME UNIT_ID_3_NAME,        "+
	"       CHNL_CODE,                            "+
	"       UNIT_ID_4_NAME,                       "+
	"       UNIT_ID_4,                            "+
	"       TOTAL_DEV,                            "+
