...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/personManagement/js/hall_mag_person_add.js"></script>
</head>
		...
		<div class="sticky-wrap" style="height: 150px;">
			...
			<input type="hidden" id="chooseMonth" name="chooseMonth"/>
			  <table>
				<tr>
				 <td>渠道编码：</td>
				 <td><input type="text" required="true" class="easyui-validatebox" missingMessage="渠道编码不能为空" name="hq_chan_code" id="hq_chan_code"/></td>
				</tr>
				<tr>
                 <td>渠道名称：
                 </td>
                ...
                <tr>
                 ...
                 <td><input type="text" readonly="readonly" required="true" class="easyui-validatebox" missingMessage="营业员姓名不能为空" name="name" id="name"/></td>
                </tr>
				<tr>
                 <td>厅主任HR编码：
                 </td>
