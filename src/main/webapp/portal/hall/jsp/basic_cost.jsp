...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/hall/js/basic_cost.js?v=3"></script>
</head>
		...
		<form id="searchForm" method="post">
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="1%" style="text-align:right;">地市：</td>
					<td width="3%">
