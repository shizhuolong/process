...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/hall/js/wx_scheme_total_day.js?v=1"></script>
</head>
	...
	<form id="searchForm" method="post">
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="4%" align="right">渠道经理：</td>
					<td width="6%">
						<input name="hq_name" id="hq_name" class="default-text-input wper80">
					</td>
					<td width="5%">
