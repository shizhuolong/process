...
<script type="text/javascript" src="<%=request.getContextPath()%>/portal/hall/js/cbxy_detail_mon.js?v=3"></script>
</head>
	...
	<form id="searchForm" method="post">
			...
			<table width="100%" style="margin: 10px 0; border:none;">
				<tr height="35px">
					...
					<td width="6%">
						<input name="hq_state" id="hq_state" class="default-text-input wper80">
					</td>
