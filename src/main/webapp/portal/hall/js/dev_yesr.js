$(function(){
	...
	var title=[["组织架构","当日拓展网点数","本周拓展网点数","当月累计拓展网点数","当年累计网点数","当年易售宝累计网点数","当年沃云霄累计网点数","当月有销量网点占比","所有网点当日销量","所有网点当月累计销量","所有网点当月店均产能","当年累计销量"]]; 
	var field=["ROW_NAME","THIS_DAY_CHNL","THIS_WEEK_CHNL","THIS_MONTH_CHNL","THIS_YEAR_CHNL","THIS_YEAR_YSB","THIS_YEAR_WYX","DEV_NUM_ZB","THIS_DEV_NUM","THIS_DEV_NUM1","CHNL_PRODUCE","THIS_DEV_YESR"];
...
function downsAll() {
	...
	var title=[["地市","营服编码","营服名称","渠道编码","渠道名称","当日拓展网点数","本周拓展网点数","当月累计拓展网点数","当年累计网点数","当年易售宝累计网点数","当年沃云霄累计网点数","当月有销量网点占比","所有网点当日销量","所有网点当月累计销量","所有网点当月店均产能","当年累计销量","创建时间","渠道类型"]];
...
function getSumSql(){
	var dealDate=$("#dealDate").val();
	return "  ,SUM(NVL(T.THIS_DAY_CHNL,0)) THIS_DAY_CHNL," +
			" SUM(NVL(T.THIS_WEEK_CHNL,0))THIS_WEEK_CHNL," +
			"SUM(NVL(T.THIS_MONTH_CHNL,0))THIS_MONTH_CHNL                                   "+
