$(function(){
	...
	var title=[["组织架构","区县/营服","营服编码","营服属性","渠道状态","发展用户数","","","","","","","同比","","","","","","","环比","","","","","",""],
	           ["","","","","","合计","移网","其中2I2C","专线","宽带","固话","其他","合计","移网","其中2I2C","专线","宽带","固话","其他","合计","移网","其中2I2C","专线","宽带","固话","其他"]];
	var field=["ROW_NAME","UNIT_NAME","UNIT_ID","UNIT_TYPE","STATE","DEV_ALL_NUM","DEV_YW_NUM","DEV_2I2C_NUM","DEV_ZZX_NUM","DEV_BB_NUM","DEV_NET_NUM","DEV_OTHER_NUM","DEV_ALL_ZB","DEV_YW_ZB","DEV_2I2C_ZB","DEV_ZZX_ZB","DEV_BB_ZB","DEV_NET_ZB","DEV_OTHER_ZB","DEV_ALL_TB","DEV_YW_TB","DEV_2I2C_TB","DEV_ZZX_TB","DEV_BB_TB","DEV_NET_TB","DEV_OTHER_TB"];
...
function downsAll() {
	...
	var showtext = '用户发展月报-' + dealDate;
	var title=[["地市","区县/营服","营服编码","营服属性","渠道状态","渠道经理HR","渠道经理","渠道编码","渠道名称","发展用户数","","","","","","","同比","","","","","","","环比","","","","","",""],
     ["","","","","","","","","","合计","移网","其中2I2C","专线","宽带","固话","其他","合计","移网","其中2I2C","专线","宽带","固话","其他","合计","移网","其中2I2C","专线","宽带","固话","其他"]];
...
function getSql(orgLevel,where){
	...
	if(orgLevel==1||orgLevel==2){
		...
		"      ,T.DEV_NET_NUM                                                                                          "+
		"      ,T.DEV_OTHER_NUM                                                                                        "+
		"      ,PMRT.LINK_RATIO(T.DEV_ALL_NUM,T2.DEV_ALL_NUM,2)     DEV_ALL_ZB                                         "+
		"      ,PMRT.LINK_RATIO(T.DEV_YW_NUM,T2.DEV_YW_NUM,2)       DEV_YW_ZB                                          "+
		"      ,PMRT.LINK_RATIO(T.DEV_2I2C_NUM,T2.DEV_2I2C_NUM,2)   DEV_2I2C_ZB                                        "+
		"      ,PMRT.LINK_RATIO(T.DEV_ZZX_NUM,T2.DEV_ZZX_NUM,2)     DEV_ZZX_ZB                                         "+
		"      ,PMRT.LINK_RATIO(T.DEV_BB_NUM,T2.DEV_BB_NUM,2)       DEV_BB_ZB                                          "+
		"      ,PMRT.LINK_RATIO(T.DEV_NET_NUM,T2.DEV_NET_NUM,2)     DEV_NET_ZB                                         "+
		"      ,PMRT.LINK_RATIO(T.DEV_OTHER_NUM,T2.DEV_OTHER_NUM,2) DEV_OTHER_ZB                                       "+
		"      ,PMRT.LINK_RATIO(T.DEV_ALL_NUM,T1.DEV_ALL_NUM,2)     DEV_ALL_TB                                         "+
		"      ,PMRT.LINK_RATIO(T.DEV_YW_NUM,T1.DEV_YW_NUM,2)       DEV_YW_TB                                          "+
		"      ,PMRT.LINK_RATIO(T.DEV_2I2C_NUM,T1.DEV_2I2C_NUM,2)   DEV_2I2C_TB                                        "+
		"      ,PMRT.LINK_RATIO(T.DEV_ZZX_NUM,T1.DEV_ZZX_NUM,2)     DEV_ZZX_TB                                         "+
		"      ,PMRT.LINK_RATIO(T.DEV_BB_NUM,T1.DEV_BB_NUM,2)       DEV_BB_TB                                          "+
		"      ,PMRT.LINK_RATIO(T.DEV_NET_NUM,T1.DEV_NET_NUM,2)     DEV_NET_TB                                         "+
		"      ,PMRT.LINK_RATIO(T.DEV_OTHER_NUM,T1.DEV_OTHER_NUM,2) DEV_OTHER_TB                                       "+
		"FROM (                                                                                                        "+
		"      select t.group_id_1 ROW_ID,                                                                             "+
		"             t.group_id_1_name ROW_NAME,                                                                      "+
		"             SUM(T.DEV_ALL_NUM)                                         DEV_ALL_NUM,                          "+
		"             sum(t.DEV_2G_NUM) + sum(t.DEV_3G_NUM) + sum(t.DEV_4G_NUM)  DEV_YW_NUM,                           "+
		"             SUM(T.DEV_2I2C_NUM)                                        DEV_2I2C_NUM,                         "+
		"             SUM(T.DEV_ZZX_NUM)                                         DEV_ZZX_NUM,                          "+
		"             sum(t.DEV_BB_NUM)                                          DEV_BB_NUM,                           "+
		"             SUM(T.DEV_NET_NUM)                                         DEV_NET_NUM,                          "+
		"             SUM(T.DEV_ALL_NUM)-sum(t.DEV_2G_NUM)-sum(t.DEV_3G_NUM)-                                          "+
		"             sum(t.DEV_4G_NUM)-SUM(T.DEV_ZZX_NUM)- sum(t.DEV_BB_NUM) - SUM(T.DEV_NET_NUM) DEV_OTHER_NUM       "+
