...
<script type="text/javascript" src="<%=path%>/workflow/workorder/activityApproval/processApprove/processApprove.js"></script>
					...
					<div class="main-block">
						...
						<table width="100%" style="margin: 10px 0;">
							<tr>
								<td width="5%">工单状态：</td>
								<td width="5%">
									<select class="default-text-input wper80" id="orderState">
										<option value="wait" selected="selected">待办</option>
			                            <option value="doing">在办</option>
			                            <option value="done">结办</option>
									</select>
								</td>
								<td width="5%">申请时间：</td>
